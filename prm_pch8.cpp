...
//#endif //PRM_PCH_DEBUG1
	...
	unsigned char mode5A=0, mode5AWest=0, mode5AEast=0;
   	unsigned char mode5A7=0, mode5A8=0;
...
unsigned char isreceived7;
unsigned char isreceived8;
...
unsigned short countTransit4,  countTransit5, countTransit6,  countTransit7, countTransit8;
unsigned short requestTransit4,requestTransit5, requestTransit6,requestTransit7, requestTransit8;
unsigned short fl1,fl2,fl3,fl4,fl5,fl6,fl7,fl8;

 unsigned char start4, start5,start6, start7,start8;
...
uEmb5StatusGeterodin	  uemb5statusgeterodin7;
uEmb5StatusGeterodin	  uemb5statusgeterodin8;
...
UnEmbUpDownStatus 	embUpDownStatus7;
UnEmbUpDownStatus 	embUpDownStatus8;

UnEmb5CommandRecieverSetFrequ emb5CommandRecieverSetFrequ7;
UnEmb5CommandRecieverSetFrequ emb5CommandRecieverSetFrequ8;

UnEmb5CommandRecieverSetAtt emb5CommandRecieverSetAtt7;
UnEmb5CommandRecieverSetAtt emb5CommandRecieverSetAtt8;

UnEmb5CommandRPUSetAtt emb5CommandRPUSetAtt7;
UnEmb5CommandRPUSetAtt emb5CommandRPUSetAtt8;

UnEmb5CommandRecieverSetSendStatus emb5CommandRecieverSetSendStatus7;
UnEmb5CommandRecieverSetSendStatus emb5CommandRecieverSetSendStatus8;

UnEmb5GetRPUState emb5GetRPUState7;
UnEmb5GetRPUState emb5GetRPUState8;

UnEmb5Acknowledge	emb5Acknowledge7;
UnEmb5Acknowledge	emb5Acknowledge8;


UnEmb5Exception emb5Exception7;
UnEmb5Exception emb5Exception8;

UnEmb5StatusReciever emb5StatusReciever7;
UnEmb5StatusReciever emb5StatusReciever8;

UnEmb5RPUState emb5RPUState7;
UnEmb5RPUState emb5RPUState8;

UnEmb5ScanFreq	 emb5ScanFreq7;
UnEmb5ScanFreq	 emb5ScanFreq8;

UnEmb5StatusFrequScan  emb5StatusFrequScan7;
UnEmb5StatusFrequScan  emb5StatusFrequScan8;

EmbMsgUD embMsgUD_7;
EmbMsgUD embMsgUD_8;

EmbMsgUD embMsgUDRequest_7;
EmbMsgUD embMsgUDRequest_8;


unsigned ans7=0;
unsigned ans8=0;

unsigned short delay7; 
unsigned short delay8; 


unsigned short countPower7=0;
unsigned short countPower8=0;

unsigned short requestPower7=0;
unsigned short requestPower8=0;

unsigned char   setf7, setatt7, modescan7;
unsigned char   setf8, setatt8, modescan8;

unsigned char  ready_power7, old_ready_power7;
unsigned char  ready_power8, old_ready_power8;

unsigned long  time7old;
unsigned long  time8old;
...
unsigned char Band1, Band2, Band3, Band4, Band5, Band6, Band7, Band8;
unsigned char Band12, Band22, Band32, Band42, Band52, Band62, Band72, Band82;
...
//============================================================78
countTransit7 = 0; countTransit8 = 0;
fl7=fl8=0; 
 requestTransit7 = 0; requestTransit8 = 0;
 start7 = 1;
 start8 = 1;
//_______________________________ ???
 mode5AWest2=0; 
...
//_______________________________
 embMsgUD_7.Init();
 embMsgUD_8.Init();
 embMsgUDRequest_7.Init();
 embMsgUDRequest_8.Init();
 setf7 = 0;
 setf8 = 0;
 setatt7 = 1; //0911090;
 setatt8 = 1; //0911090;
 ...
 for(i=0; i<16; i++)
	{
 	 embUpDownStatus7.byte[i] = 0;
 	 embUpDownStatus8.byte[i] = 0;
 	}
  time7old=0;
  time8old=0;
  delay7 = NO_SCAN_DELAY;
  delay8 = NO_SCAN_DELAY;
...
extern "C" void  SetFreq7();
extern "C" void  SetFreq8();
 ...
 if(GetTestMode() == 0x50)
{
 ...
 printfpd("\n\rh1:%02X ",unEmb2TypeVer.emb2TypeVer.signature_hardware[1]);
 printfpd("h2: %02X ",unEmb2TypeVer.emb2TypeVer.signature_hardware[2]);
 printfpd("h3: %02X ",unEmb2TypeVer.emb2TypeVer.signature_hardware[3]);
 printfpd("h4: %02X ",unEmb2TypeVer.emb2TypeVer.signature_hardware[4]);
 printfpd("h5: %02X ",unEmb2TypeVer.emb2TypeVer.signature_hardware[5]);
 printfpd("h6: %02X ",unEmb2TypeVer.emb2TypeVer.signature_hardware[6]);
 printfpd("h7: %02X ",unEmb2TypeVer.emb2TypeVer.signature_hardware[7]);
 printfpd("\n\r h8 : %02X",unEmb2TypeVer.emb2TypeVer.signature_hardware[8]);
 printfpd("h9: %02X ",unEmb2TypeVer.emb2TypeVer.signature_hardware[9]);
 printfpd("h10: %02X ",unEmb2TypeVer.emb2TypeVer.signature_hardware[10]);
 printfpd("h11: %02X ",unEmb2TypeVer.emb2TypeVer.signature_hardware[11]);
 printfpd("h12: %02X ",unEmb2TypeVer.emb2TypeVer.signature_hardware[12]);
 printfpd("h13: %02X ",unEmb2TypeVer.emb2TypeVer.signature_hardware[13]);
 printfpd("h14: %02X ",unEmb2TypeVer.emb2TypeVer.signature_hardware[14]);
 printfpd("h15: %02X ",unEmb2TypeVer.emb2TypeVer.signature_hardware[15]);
	
  	printfp("\n\r");

	   //		 for(i = 1; i < 11; i++)
	   //		{
	   	//			printfpd(" %02X", emb5StatusReciever7.byte[i]);
...
//#endif //COMMAND_RESENDING
		...
		if( ((time1-time4old) > delay4)	 &&  (power_port & CH4_MASK)) // <<<! make later
		{
			time4old = time1;
	   //	  printf("\n\r >>4");
...
//#endif //PRM_PCH_DEBUG
					...
					case 0xA5: embSerialACT155.AddMod(0x5A); embSerialACT155.AddMod(0x02); break;
					case 0xAA: embSerialACT155.AddMod(0x5A); embSerialACT155.AddMod(0x03); break;
					default: embSerialACT155.AddMod(embMsgUDRequest_4.body[i]);
					}
				}
   //			   embMsgUDRequest_4.Init();
//#ifndef COMMAND_RESENDING
...
//#endif //COMMAND_RESENDING
		...
		if( ((time1-time5old) > delay5)	 && (!(start4)) &&  (power_port & CH5_MASK)) // <<<4 is finished
		{
			time5old = time1;
  		  if(modescan5)
		   {
...
if(GetTestMode() == 0x50)
			{
		  	  printfpd(".%02X",embMsgUDRequest_5.body[i]);
			}
//#endif //PRM_PCH_DEBUG
					...
					case 0xA5: embSerialACT155.AddMod(0x5A); embSerialACT155.AddMod(0x02); break;
					case 0xAA: embSerialACT155.AddMod(0x5A); embSerialACT155.AddMod(0x03); break;
					default: embSerialACT155.AddMod(embMsgUDRequest_5.body[i]);
					}
				}
  //			   embMsgUDRequest_5.Init();
//#ifndef COMMAND_RESENDING
...
//#endif //COMMAND_RESENDING
		...
		if( ((time1-time6old) > delay6)	 && (!(start5)) &&  (power_port & CH6_MASK)) // <<<5 is finished
		{
			time6old = time1;
  		  if(modescan6)
		   {
...
if(GetTestMode() == 0x50)
			{
		   	  printfpd(".%02X",embMsgUDRequest_6.body[i]);
			}
//#endif //PRM_PCH_DEBUG
					...
					case 0xA5: embSerialACT155.AddMod(0x5A); embSerialACT155.AddMod(0x02); break;
					case 0xAA: embSerialACT155.AddMod(0x5A); embSerialACT155.AddMod(0x03); break;
					default: embSerialACT155.AddMod(embMsgUDRequest_6.body[i]);
					}
				}
//			   embMsgUDRequest_6.Init();
//#ifndef COMMAND_RESENDING
...
//_______________________________________________________________________________________<<_6
//_______________________________________________________________________________________>>_7

if(power_port & CH7_MASK)
{
	 //	while(embSerialACT155.UsedTransit())
	  //	 printfp("\n\r____CH7 : \n\r");
   /*
if(embMsgUDRequest_7.IsReadyToSend())
 	{
	printfp("\n\r...ready ");
	}
	else
	...
	*/
		while(embSerialACT155.UsedMod())
		{
		 ...
		 // 	 printfpd(".%0X", byte);	//t
			...
			switch(byte)
			{
				case 0xAA: embMsgUD_7.Init(); isreceived7 = 1; break; // Пакет
				case 0x5A: mode5A7=1; break;
				default:
					if(mode5A7) 
					{
					    if(isreceived7) {	embMsgUD_7.Add(Modify5A(byte));}
						mode5A7=0;
					}
					else
					 {
					    if(isreceived7) { embMsgUD_7.Add(byte);}
					 }
			}
			if(embMsgUD_7.IsEnd())
			{		
...
if(GetTestMode() == 0x50)
			{
				...
				for(i=0; i<12; i++)
				{
						...
						printfpd(".%0X",embMsgUD_7.Body(i));
					
				}
		   	}
//#endif // PRM_PCH_DEBUG
			 //	AlarmPmOff2();  //make in future
				embUpDownStatus7.embupdownstatus.received++;
				if(embMsgUD_7.ChkCRC())	{  breakflag = 1;
						countTransit7=0;
//#ifdef COMMAND_RESENDING
   	   if(!modescan7)
   	   {
   //	   printfp("\n\r 	embMsgUDRequest_7..Init() ");

   	   	embMsgUDRequest_7.Init();  //in modescan1 = 1 it is init immediatly
		delay7 = NO_SCAN_DELAY;
	   }
	      else
	   {
#ifdef SCAN_RESEND
   		MakeNextStepScan7();  //t151209
   	 //	time1old = 0; //immediatly send next
#endif
	   }
...
//#endif //COMMAND_RESENDING
				...
				fl7 =1;
				ParseUD_7();
				embUpDownStatus7.embupdownstatus.crc_ok++;   }
				else { embUpDownStatus7.embupdownstatus.crc_bad++;	}
				 embMsgUD_7.Init();
				break;
			}
		}
		...
		if( ((time1-time7old) > delay7)	 && (!(start6)) &&  (power_port & CH7_MASK)) // <<<5 is finished
		{
			time7old = time1;
	 ...
	 //	printfp("\n\rtime ok ....");
		  ...
		  //	MakeNextStepScan7(); 
			...
			MakeNextStepScan7(); 
#else
	       SetFreq7();//t151209 set previons freq
#endif
...
//		     delay6 = NO_SCAN_DELAY;
//#else  // COMMAND_RESENDING
			 if(!countTransit7) delay7 = NO_SCAN_DELAY;
			 else delay7 = RESENDING_DELAY;
//#endif // COMMAND_RESENDING
 ...
 if(embMsgUDRequest_7.IsReadyToSend())
  ...
  //	printfp("\n\r send............");
					countTransit7++;
//#ifdef COMMAND_RESENDING
			    if(!modescan7) delay7 = RESENDING_DELAY;
//#endif // COMMAND_RESENDING

			embUpDownStatus7.embupdownstatus.sendup++;
...
//#endif //PRM_PCH_DEBUG
				...
				embSerialACT155.AddMod(0xFF);
		 		embSerialACT155.AddMod(0xAA);
	  	 		for(i=0; i<embMsgUDRequest_7.Length()+5; i++) 
				{
//#ifdef PRM_PCH_DEBUG
if(GetTestMode() == 0x50)
			{
		   	  printfpd(".%02X",embMsgUDRequest_7.body[i]);
			}
//#endif //PRM_PCH_DEBUG
					switch(embMsgUDRequest_7.body[i])
					{
					case 0x5A: embSerialACT155.AddMod(0x5A); embSerialACT155.AddMod(0x00); break;
					case 0x55: embSerialACT155.AddMod(0x5A); embSerialACT155.AddMod(0x01); break;
					case 0xA5: embSerialACT155.AddMod(0x5A); embSerialACT155.AddMod(0x02); break;
					case 0xAA: embSerialACT155.AddMod(0x5A); embSerialACT155.AddMod(0x03); break;
					default: embSerialACT155.AddMod(embMsgUDRequest_7.body[i]);
					}
				}
//			   embMsgUDRequest_6.Init();
//#ifndef COMMAND_RESENDING
...
//#endif
 				for(i=0; i<embMsgUDRequest_7.Length()+3; i++) 
				{
//#ifdef PRM_PCH_DEBUG
if(GetTestMode() == 0x50)
//if(1)
...
//				{
		  ...
		  //		printfp("\n\r 1	embMsgUDRequest_7..Init() ");

						embMsgUDRequest_7.Init();	//060919
				}
			}
//091110}

		if(countTransit7>MAX_COUNT_MOD) 
		{
  		 setf7 = 0;
  		 setatt7 = 1; //0911090;
		 fl7 = 0;
//#ifdef COMMAND_RESENDING
//printfp("\n\r 2	embMsgUDRequest_7..Init() ");
...
//_______________________________________________________________________________________<<_7
//_______________________________________________________________________________________>>_8

if(power_port & CH8_MASK)
{
	 //	while(embSerialACT155.UsedTransit())
		while(embSerialACT155.UsedMod())
		{
		  ...
		  //	 printf(".%0X", byte);	//t
			...
			switch(byte)
			{
				case 0xAA: embMsgUD_8.Init(); isreceived8 = 1; break; // Пакет
				case 0x5A: mode5A8=1; break;
				default:
					if(mode5A8) 
					{
					    if(isreceived8) {	embMsgUD_8.Add(Modify5A(byte));}
						mode5A8=0;
					}
					else
					 {
					    if(isreceived8) { embMsgUD_8.Add(byte);}
					 }
			}
			if(embMsgUD_8.IsEnd())
			{		
...
if(GetTestMode() == 0x50)
			{
				...
				for(i=0; i<12; i++)
				{
						...
						printfpd(".%0X",embMsgUD_8.Body(i));
					
				}
		   	}
//#endif // PRM_PCH_DEBUG
			  //	AlarmPmOff2();  //make in future
				embUpDownStatus8.embupdownstatus.received++;
				if(embMsgUD_8.ChkCRC())	{  breakflag = 1;
						countTransit8=0;
//#ifdef COMMAND_RESENDING
   	   if(!modescan8)
   	   {
   	   	embMsgUDRequest_8.Init();  //in modescan1 = 1 it is init immediatly
		delay6 = NO_SCAN_DELAY;
	   }
	      else
	   {
#ifdef SCAN_RESEND
   		MakeNextStepScan8();  //t151209
   	 //	time1old = 0; //immediatly send next
#endif
	   }
...
//#endif //COMMAND_RESENDING
				...
				fl8 =1;
				ParseUD_8();
				embUpDownStatus8.embupdownstatus.crc_ok++;   }
				else { embUpDownStatus8.embupdownstatus.crc_bad++;	}
				 embMsgUD_8.Init();
				break;
			}
		}
		if( ((time1-time8old) > delay8)	 && (!(start7)) &&  (power_port & CH8_MASK)) // <<<5 is finished
		{
			time8old = time1;
  		  if(modescan8)
		   {
		  //	MakeNextStepScan8(); 
			...
			MakeNextStepScan8(); 
#else
	       SetFreq8();//t151209 set previons freq
#endif
...
//		     delay6 = NO_SCAN_DELAY;
//#else  // COMMAND_RESENDING
			 if(!countTransit8) delay8 = NO_SCAN_DELAY;
			 else delay8 = RESENDING_DELAY;
//#endif // COMMAND_RESENDING

		   }
			if(embMsgUDRequest_8.IsReadyToSend())
			{
					countTransit8++;
//#ifdef COMMAND_RESENDING
			    if(!modescan8) delay8 = RESENDING_DELAY;
//#endif // COMMAND_RESENDING

			embUpDownStatus8.embupdownstatus.sendup++;
...
//#endif //PRM_PCH_DEBUG
				...
				embSerialACT155.AddMod(0xFF);
		 		embSerialACT155.AddMod(0xAA);
	  	 		for(i=0; i<embMsgUDRequest_8.Length()+5; i++) 
				{
//#ifdef PRM_PCH_DEBUG
if(GetTestMode() == 0x50)
			{
		   	  printfpd(".%02X",embMsgUDRequest_8.body[i]);
			}
//#endif //PRM_PCH_DEBUG
					switch(embMsgUDRequest_8.body[i])
					{
					case 0x5A: embSerialACT155.AddMod(0x5A); embSerialACT155.AddMod(0x00); break;
					case 0x55: embSerialACT155.AddMod(0x5A); embSerialACT155.AddMod(0x01); break;
					case 0xA5: embSerialACT155.AddMod(0x5A); embSerialACT155.AddMod(0x02); break;
					case 0xAA: embSerialACT155.AddMod(0x5A); embSerialACT155.AddMod(0x03); break;
					default: embSerialACT155.AddMod(embMsgUDRequest_8.body[i]);
					}
				}
//			   embMsgUDRequest_6.Init();
//#ifndef COMMAND_RESENDING
//   	 	embMsgUDRequest_6.Init();
//#else  // COMMAND_RESENDING
	  if(modescan6)	embMsgUDRequest_8.Init();
//#endif //COMMAND_RESENDING
...
//#endif
 				for(i=0; i<embMsgUDRequest_8.Length()+3; i++) 
				{
//#ifdef PRM_PCH_DEBUG
if(GetTestMode() == 0x50)
			{
...
//				{
					...
					default: embSerialACT155.AddMod(embMsgUDRequest_8.body[i]);
						...
						embMsgUDRequest_8.Init();	//060919
				}
			}
//091110}

		if(countTransit8>MAX_COUNT_MOD) 
		{
  		 setf8 = 0;
  		 setatt8 = 1; //0911090;
		 fl8 = 0;
...
extern "C" void  SetAttRPU1(unsigned char val)
{
 ...
 //  unEmb2TypeVer.emb2TypeVer.signature_software[12] = FIX_ATT;
   unEmb2TypeVer.emb2TypeVer.signature_software[12] = FIX_ATT>>1;
   unEmb2TypeVer.emb2TypeVer.signature_hardware[12] = FIX_ATT >> 1;
     unEmb2TypeVer.emb2TypeVer.signature_hardware[13] = FIX_ATT >> 1;
...
#ifdef PROG_PRM_PCH_L_61
   pio_ptr->SODR = MASK_BIT_14; //set olweis to zero 14
#endif
}
...
//_______________________________________________________________________________________________
   ...
   emb5CommandRPUSetAtt4.emb5commandrpusetatt.stepAtt =  RestoreParam(ATT4_ADDR_RPU);
    unEmb2TypeVer.emb2TypeVer.signature_hardware[12] = emb5CommandRPUSetAtt4.emb5commandrpusetatt.stepAtt;
   //	 SetAttRPU4();
   ...
   emb5CommandRPUSetAtt5.emb5commandrpusetatt.stepAtt =  RestoreParam(ATT5_ADDR_RPU);
    unEmb2TypeVer.emb2TypeVer.signature_hardware[12] = emb5CommandRPUSetAtt5.emb5commandrpusetatt.stepAtt;
  //	 SetAttRPU5();
   ...
   emb5CommandRPUSetAtt6.emb5commandrpusetatt.stepAtt =  RestoreParam(ATT6_ADDR_RPU);
    unEmb2TypeVer.emb2TypeVer.signature_hardware[12] = emb5CommandRPUSetAtt6.emb5commandrpusetatt.stepAtt;
  //	 SetAttRPU6();

//_______________________________________________________________________________________________
#endif //PRM_PCH_SIX_LINES

    emb5CommandRecieverSetFrequ7.emb5commandrecieversetfrequ.frequ = RestoreParam(FREQ7_ADDR);
   emb5StatusReciever7.emb5statusreciever.frequ =  emb5CommandRecieverSetFrequ7.emb5commandrecieversetfrequ.frequ;
   emb5CommandRecieverSetAtt7.emb5commandrecieversetatt.stepAtt =  RestoreParam(ATT7_ADDR);
   emb5StatusReciever7.emb5statusreciever.stepAtt =  emb5CommandRecieverSetAtt7.emb5commandrecieversetatt.stepAtt;   
   emb5CommandRPUSetAtt7.emb5commandrpusetatt.stepAtt =  RestoreParam(ATT7_ADDR_RPU);
    unEmb2TypeVer.emb2TypeVer.signature_hardware[12] = emb5CommandRPUSetAtt6.emb5commandrpusetatt.stepAtt;


   emb5CommandRecieverSetFrequ8.emb5commandrecieversetfrequ.frequ = RestoreParam(FREQ8_ADDR);
   emb5StatusReciever8.emb5statusreciever.frequ =  emb5CommandRecieverSetFrequ8.emb5commandrecieversetfrequ.frequ;
   emb5CommandRecieverSetAtt8.emb5commandrecieversetatt.stepAtt =  RestoreParam(ATT8_ADDR);
   emb5StatusReciever8.emb5statusreciever.stepAtt =  emb5CommandRecieverSetAtt8.emb5commandrecieversetatt.stepAtt;   
   emb5CommandRPUSetAtt8.emb5commandrpusetatt.stepAtt =  RestoreParam(ATT8_ADDR_RPU);
    unEmb2TypeVer.emb2TypeVer.signature_hardware[12] = emb5CommandRPUSetAtt6.emb5commandrpusetatt.stepAtt;



  unEmb2TypeVer.emb2TypeVer.signature_hardware[13] = unEmb2TypeVer.emb2TypeVer.signature_hardware[12];

}
extern "C" void  ParseCommand2(char *IPBuff)
{
//printfpd("\n\r  ParseCommand2 : %d", IPBuff[1]);
 	switch(IPBuff[1])
	{
case  1 : 
       	   modescan1 = 0;
...
case  7 : 
		  ...
		  countTransit7 = 0;
		  delay7 = NO_SCAN_DELAY;
		  emb5CommandRecieverSetFrequ7.emb5commandrecieversetfrequ.frequ =  (IPBuff[5] << 24) + (IPBuff[4] << 16) +  (IPBuff[3] << 8)  + IPBuff[2]; 
 		   KeepParam(emb5CommandRecieverSetFrequ7.emb5commandrecieversetfrequ.frequ , FREQ7_ADDR);
		   emb5StatusReciever7.emb5statusreciever.frequ = emb5CommandRecieverSetFrequ7.emb5commandrecieversetfrequ.frequ;
	  //	  	printfpd("\n\r  freq : : %d", emb5StatusReciever7.emb5statusreciever.frequ);
...
case  8 : 
		  ...
		  countTransit8 = 0;
		  delay8 = NO_SCAN_DELAY;
		  emb5CommandRecieverSetFrequ8.emb5commandrecieversetfrequ.frequ =  (IPBuff[5] << 24) + (IPBuff[4] << 16) +  (IPBuff[3] << 8)  + IPBuff[2]; 
 		   KeepParam(emb5CommandRecieverSetFrequ8.emb5commandrecieversetfrequ.frequ , FREQ8_ADDR);
		   emb5StatusReciever8.emb5statusreciever.frequ = emb5CommandRecieverSetFrequ8.emb5commandrecieversetfrequ.frequ;
		   SetFreq8();
#ifdef	   PROG_PRM_PCH_L
 		   SetNeedWriteDevId2();
...
case  7 : 
	   //	    modescan7 = 0;
			countTransit7 = 0;
  			delay7 = NO_SCAN_DELAY;
			emb5CommandRecieverSetAtt7.emb5commandrecieversetatt.stepAtt = MakeAtt(IPBuff[2]); 
	//		emb5StatusReciever6.emb5statusreciever.stepAtt =  emb5CommandRecieverSetAtt6.emb5commandrecieversetatt.stepAtt;   
   			KeepParam(emb5CommandRecieverSetAtt7.emb5commandrecieversetatt.stepAtt , ATT7_ADDR);		  
		    SetAtt7();
#ifdef	   PROG_PRM_PCH_L
 		   SetNeedWriteDevId2();
#endif     // PROG_PRM_PCH_L
...
case  8 : 
		//    modescan8 = 0;
			countTransit8 = 0;
  			delay8 = NO_SCAN_DELAY;
			emb5CommandRecieverSetAtt8.emb5commandrecieversetatt.stepAtt = MakeAtt(IPBuff[2]); 
	//		emb5StatusReciever6.emb5statusreciever.stepAtt =  emb5CommandRecieverSetAtt6.emb5commandrecieversetatt.stepAtt;   
   			KeepParam(emb5CommandRecieverSetAtt8.emb5commandrecieversetatt.stepAtt , ATT8_ADDR);		  
		    SetAtt8();
#ifdef	   PROG_PRM_PCH_L
 		   SetNeedWriteDevId2();
#endif     // PROG_PRM_PCH_L
...
case  7 :   
		 //	  modescan7 = 0;
			  delay7 = NO_SCAN_DELAY;
			  emb5StatusReciever7.emb5statusreciever.genStatus = 2;// IPBuff[2];
		    add_char_TCP_buff(IPBuff[1]);
		   //	printfp("\n\r");
			 for(i = 1; i < 11; i++)
	 		{
	   				add_char_TCP_buff(emb5StatusReciever7.byte[i]);
...
case  8 :   
		 //	  modescan8 = 0;
			  delay8 = NO_SCAN_DELAY;
			  emb5StatusReciever8.emb5statusreciever.genStatus = 2;// IPBuff[2];
		    add_char_TCP_buff(IPBuff[1]);
			 for(i = 1; i < 11; i++)
	 		{
	   				add_char_TCP_buff(emb5StatusReciever8.byte[i]);
	 		}
 			break;
...
case  7 :   for(i = 0; i < 20; i++)
	 		{
	   		add_char_TCP_buff(emb5RPUState7.byte[i]);
	 		}
			break;
case  8 :   for(i = 0; i < 20; i++)
	 		{
	   		add_char_TCP_buff(emb5RPUState8.byte[i]);
	 		}
			break;
...
case  7 : 
 	//	if(unEmb2TypeVer.emb2TypeVer.signature_hardware[7])	  //need correct
		if(1)	  //need correct
		   {
			  add_char_TCP_buff(TYPE_RUN_OK);
		   }
		   else
		   {
			...
			emb5ScanFreq7.emb5scanfreq.frequStart =  IPBuff[2] +  (IPBuff[3] << 8) +  (IPBuff[4] << 16)	+    (IPBuff[5] << 24);
			emb5ScanFreq7.emb5scanfreq.step = IPBuff[6] +  (IPBuff[7] << 8);
			emb5ScanFreq7.emb5scanfreq.numOfStep = 	IPBuff[8] +  (IPBuff[9] << 8);
			if(emb5ScanFreq7.emb5scanfreq.numOfStep > MAX_STEPS) emb5ScanFreq7.emb5scanfreq.numOfStep = MAX_STEPS;
			emb5CommandRecieverSetFrequ7.emb5commandrecieversetfrequ.frequ =  emb5ScanFreq7.emb5scanfreq.frequStart;
   			emb5StatusReciever7.emb5statusreciever.frequ =  emb5CommandRecieverSetFrequ7.emb5commandrecieversetfrequ.frequ;
			emb5StatusFrequScan7.emb5statusfrequscan.number =   emb5ScanFreq7.emb5scanfreq.number;
			emb5StatusFrequScan7.emb5statusfrequscan.frequStart =   emb5ScanFreq7.emb5scanfreq.frequStart;
			emb5StatusFrequScan7.emb5statusfrequscan.step =   emb5ScanFreq7.emb5scanfreq.step;
			emb5StatusFrequScan7.emb5statusfrequscan.numOfStep =   emb5ScanFreq7.emb5scanfreq.numOfStep;
			emb5StatusFrequScan7.emb5statusfrequscan.att =   emb5StatusReciever7.emb5statusreciever.stepAtt;
		    modescan7 = 1; //start scan channel2
	    	curval7 = -2;
		   	emb5ScanFreq7.emb5scanfreq.numOfStep += (unsigned short)2;
			delay7 = SCAN_DELAY;
			for(i = 0; i < emb5ScanFreq7.emb5scanfreq.numOfStep; i++)
				{
	  				emb5StatusFrequScan7.emb5statusfrequscan.level[i] = ConvVal(0);
				}
		    break;
 	...
 	//	if(unEmb2TypeVer.emb2TypeVer.signature_hardware[7]) //need correct	  
		if(1)
		   ...
		   else
		   {
			...
			emb5ScanFreq8.emb5scanfreq.frequStart =  IPBuff[2] +  (IPBuff[3] << 8) +  (IPBuff[4] << 16)	+    (IPBuff[5] << 24);
			emb5ScanFreq8.emb5scanfreq.step = IPBuff[6] +  (IPBuff[7] << 8);
			emb5ScanFreq8.emb5scanfreq.numOfStep = 	IPBuff[8] +  (IPBuff[9] << 8);
			if(emb5ScanFreq8.emb5scanfreq.numOfStep > MAX_STEPS) emb5ScanFreq8.emb5scanfreq.numOfStep = MAX_STEPS;
			emb5CommandRecieverSetFrequ8.emb5commandrecieversetfrequ.frequ =  emb5ScanFreq8.emb5scanfreq.frequStart;
   			emb5StatusReciever8.emb5statusreciever.frequ =  emb5CommandRecieverSetFrequ8.emb5commandrecieversetfrequ.frequ;
			emb5StatusFrequScan8.emb5statusfrequscan.number =   emb5ScanFreq8.emb5scanfreq.number;
			emb5StatusFrequScan8.emb5statusfrequscan.frequStart =   emb5ScanFreq8.emb5scanfreq.frequStart;
			emb5StatusFrequScan8.emb5statusfrequscan.step =   emb5ScanFreq8.emb5scanfreq.step;
			emb5StatusFrequScan8.emb5statusfrequscan.numOfStep =   emb5ScanFreq8.emb5scanfreq.numOfStep;
			emb5StatusFrequScan8.emb5statusfrequscan.att =   emb5StatusReciever8.emb5statusreciever.stepAtt;
		    modescan8 = 1; //start scan channel2
	    	curval8 = -2;
		   	emb5ScanFreq8.emb5scanfreq.numOfStep += (unsigned short)2;
			delay8 = SCAN_DELAY;
			for(i = 0; i < emb5ScanFreq8.emb5scanfreq.numOfStep; i++)
				{
	  				emb5StatusFrequScan8.emb5statusfrequscan.level[i] = ConvVal(0);
				}
		    break;
//__________________________________________________________________________________4
...
case  7 : 
	//   if(unEmb2TypeVer.emb2TypeVer.signature_hardware[7])	  //need correct
	   if(1)	  //need correct
		  ...
		  //	modescan7 = 0;
  			delay7 = NO_SCAN_DELAY;
		  	add_char_TCP_buff(emb5StatusFrequScan7.emb5statusfrequscan.number);		  //0
			add_char_TCP_buff(emb5StatusFrequScan7.emb5statusfrequscan.frequStart);	   //1
			add_char_TCP_buff(emb5StatusFrequScan7.emb5statusfrequscan.frequStart>>8);	//2
			add_char_TCP_buff(emb5StatusFrequScan7.emb5statusfrequscan.frequStart>>16);	 //3
			add_char_TCP_buff(emb5StatusFrequScan7.emb5statusfrequscan.frequStart>>24);	 //4
			add_char_TCP_buff(emb5StatusFrequScan7.emb5statusfrequscan.step);			 //5
			add_char_TCP_buff(emb5StatusFrequScan7.emb5statusfrequscan.step>>8);		 //6
			add_char_TCP_buff(emb5StatusFrequScan7.emb5statusfrequscan.numOfStep);		 //7
			add_char_TCP_buff(emb5StatusFrequScan7.emb5statusfrequscan.numOfStep>>8);	  //8
			add_char_TCP_buff(emb5StatusFrequScan7.emb5statusfrequscan.att);		//9

	 	for(i = 14; i < ((emb5StatusFrequScan7.emb5statusfrequscan.numOfStep << 1) + 14) ; i++)
	 	 	{
	   			add_char_TCP_buff(emb5StatusFrequScan7.byte[i]);
	 		}
			break;
...
case  8 : 
   //	   if(unEmb2TypeVer.emb2TypeVer.signature_hardware[7])	   //need correct	
		 ...
		 //	modescan8 = 0;
  			delay8 = NO_SCAN_DELAY;
		  	add_char_TCP_buff(emb5StatusFrequScan8.emb5statusfrequscan.number);		  //0
			add_char_TCP_buff(emb5StatusFrequScan8.emb5statusfrequscan.frequStart);	   //1
			add_char_TCP_buff(emb5StatusFrequScan8.emb5statusfrequscan.frequStart>>8);	//2
			add_char_TCP_buff(emb5StatusFrequScan8.emb5statusfrequscan.frequStart>>16);	 //3
			add_char_TCP_buff(emb5StatusFrequScan8.emb5statusfrequscan.frequStart>>24);	 //4
			add_char_TCP_buff(emb5StatusFrequScan8.emb5statusfrequscan.step);			 //5
			add_char_TCP_buff(emb5StatusFrequScan8.emb5statusfrequscan.step>>8);		 //6
			add_char_TCP_buff(emb5StatusFrequScan8.emb5statusfrequscan.numOfStep);		 //7
			add_char_TCP_buff(emb5StatusFrequScan8.emb5statusfrequscan.numOfStep>>8);	  //8
			add_char_TCP_buff(emb5StatusFrequScan8.emb5statusfrequscan.att);		//9

	 	for(i = 14; i < ((emb5StatusFrequScan8.emb5statusfrequscan.numOfStep << 1) + 14) ; i++)
	 	 	{
	   			add_char_TCP_buff(emb5StatusFrequScan8.byte[i]);
	 		}
			break;
//_____________________________________________________________________________________4
...
case  7 : 
		 	for(i = 0; i <  16; i++)
	 	 	{
	   			add_char_TCP_buff(embUpDownStatus7.byte[i]);
				embUpDownStatus7.byte[i] = 0l;
	 		}
			break;
...
case  8 : 
		 	for(i = 0; i <  16; i++)
	 	 	{
	   			add_char_TCP_buff(embUpDownStatus8.byte[i]);
				embUpDownStatus8.byte[i] = 0l;
	 		}
			break;
...
case  7 : 
		 	for(i = 0; i <  12; i++)
	 	 	{
	   		 add_char_TCP_buff(uemb5statusgeterodin7.byte[i]);
...
case  8 : 
		 	for(i = 0; i <  12; i++)
	 	 	{
	   		 add_char_TCP_buff(uemb5statusgeterodin8.byte[i]);
...
case  7 : 
		 //   modescan7 = 0;
			countTransit7 = 0;
  			delay7 = NO_SCAN_DELAY;
		    emb5CommandRPUSetAtt7.emb5commandrpusetatt.stepAtt = IPBuff[2];  
 		    unEmb2TypeVer.emb2TypeVer.signature_hardware[12] = IPBuff[2];
  unEmb2TypeVer.emb2TypeVer.signature_hardware[13] = unEmb2TypeVer.emb2TypeVer.signature_hardware[12];
   ...
   //			emb5StatusReciever4.emb5statusreciever.stepAtt =  emb5CommandRecieverSetAtt4.emb5commandrecieversetatt.stepAtt;   
   		//	KeepParam(emb5CommandRPUSetAtt4.emb5commandrpusetatt.stepAtt , ATT4_ADDR_RPU);
		//	KeepParam(emb5CommandRPUSetAtt5.emb5commandrpusetatt.stepAtt , ATT5_ADDR_RPU);
		KeepParam(emb5CommandRPUSetAtt7.emb5commandrpusetatt.stepAtt , ATT7_ADDR_RPU);   							  
		    SetAttRPU1(unEmb2TypeVer.emb2TypeVer.signature_hardware[12]);
 unEmb2TypeVer.emb2TypeVer.signature_software[12] = IPBuff[2];
#ifdef	   PROG_PRM_PCH_L
 		   SetNeedWriteDevId2();
...
case  8 : 
	  ...
	  //	     emb5CommandRPUSetAtt4.emb5commandrpusetatt.stepAtt = IPBuff[2];  
  // emb5CommandRPUSetAtt5.emb5commandrpusetatt.stepAtt = IPBuff[2]; 
   emb5CommandRPUSetAtt8.emb5commandrpusetatt.stepAtt = IPBuff[2]; 
			unEmb2TypeVer.emb2TypeVer.signature_hardware[12] = IPBuff[2];
  unEmb2TypeVer.emb2TypeVer.signature_hardware[13] = unEmb2TypeVer.emb2TypeVer.signature_hardware[12];
   ...
   //			emb5StatusReciever4.emb5statusreciever.stepAtt =  emb5CommandRecieverSetAtt4.emb5commandrecieversetatt.stepAtt;   
   		//	KeepParam(emb5CommandRPUSetAtt4.emb5commandrpusetatt.stepAtt , ATT4_ADDR_RPU);
	 //		KeepParam(emb5CommandRPUSetAtt5.emb5commandrpusetatt.stepAtt , ATT5_ADDR_RPU);
		KeepParam(emb5CommandRPUSetAtt8.emb5commandrpusetatt.stepAtt , ATT8_ADDR_RPU);   							  
		    SetAttRPU1(unEmb2TypeVer.emb2TypeVer.signature_hardware[12]);
 unEmb2TypeVer.emb2TypeVer.signature_software[12] = IPBuff[2];
#ifdef	   PROG_PRM_PCH_L
 		   SetNeedWriteDevId2();
...
extern "C" void  SetAtt7_12(unsigned char val)
{
				embMsgUDRequest_7.Init();
				embMsgUDRequest_7.SetAddr(0);//embMsg.Body(0));
				embMsgUDRequest_7.SetLength(2); //?????
				embMsgUDRequest_7.SetBody(0,CODE_SET_ATT_12);	//
			    embMsgUDRequest_7.SetBody(1, val);	//
		  		embMsgUDRequest_7.CalcCRC();
				embMsgUDRequest_7.SetReadyToSend();
}

extern "C" void  SetAtt8_12(unsigned char val)
{
				embMsgUDRequest_8.Init();
				embMsgUDRequest_8.SetAddr(0);//embMsg.Body(0));
				embMsgUDRequest_8.SetLength(2); //?????
				embMsgUDRequest_8.SetBody(0,CODE_SET_ATT_12);	//
			    embMsgUDRequest_8.SetBody(1, val);	//
		  		embMsgUDRequest_8.CalcCRC();
				embMsgUDRequest_8.SetReadyToSend();
}
...
extern "C" void  SetAtt7_13(unsigned char val)
{
				embMsgUDRequest_7.Init();
				embMsgUDRequest_7.SetAddr(0);//embMsg.Body(0));
				embMsgUDRequest_7.SetLength(2); //?????
				embMsgUDRequest_7.SetBody(0,CODE_SET_ATT_13);	//
			    embMsgUDRequest_7.SetBody(1, val);	//
		  		embMsgUDRequest_7.CalcCRC();
				embMsgUDRequest_7.SetReadyToSend();
}

extern "C" void  SetAtt8_13(unsigned char val)
{
				embMsgUDRequest_8.Init();
				embMsgUDRequest_8.SetAddr(0);//embMsg.Body(0));
				embMsgUDRequest_8.SetLength(2); //?????
				embMsgUDRequest_8.SetBody(0,CODE_SET_ATT_13);	//
			    embMsgUDRequest_8.SetBody(1, val);	//
		  		embMsgUDRequest_8.CalcCRC();
				embMsgUDRequest_8.SetReadyToSend();
}
...
unsigned char WriteStatus1,WriteStatus2,WriteStatus3,WriteStatus4,WriteStatus5,WriteStatus6,WriteStatus7,WriteStatus8;
unsigned char ReadStatus1[3], ReadStatus2[3], ReadStatus3[3], ReadStatus4[3], ReadStatus5[3], ReadStatus6[3], ReadStatus7[3], ReadStatus8[3];
unsigned char ReadAtt1[3], ReadAtt2[3], ReadAtt3[3], ReadAtt4[3], ReadAtt5[3], ReadAtt6[3], ReadAtt7[3], ReadAtt8[3]; 
...
extern "C" void  GetFlash7(char *pAddrData)
{
  ReadStatus7[0] = 0;
  ReadStatus7[1] = 0;
  ReadStatus7[2] = 0;
				...
				embMsgUDRequest_7.Init();
				embMsgUDRequest_7.SetAddr(0);//emgUDRequest_1.Init();
 		     	embMsgUDRequest_7.SetLength(GET_FLASH_LEN); //em
				embMsgUDRequest_7.SetBody(0 , CODE_GETFLASH);
			    for(long i = 1; i < GET_FLASH_LEN; i++)
				{
				 embMsgUDRequest_7.SetBody(i , *pAddrData++);	//temporary
				}
		  		embMsgUDRequest_7.CalcCRC();
				embMsgUDRequest_7.SetReadyToSend();
}
...
extern "C" void  GetFlash8(char *pAddrData)
{
  ReadStatus8[0] = 0;
  ReadStatus8[1] = 0;
  ReadStatus8[2] = 0;
				...
				embMsgUDRequest_8.Init();
				embMsgUDRequest_8.SetAddr(0);//emgUDRequest_1.Init();
 		     	embMsgUDRequest_8.SetLength(GET_FLASH_LEN); //em
				embMsgUDRequest_8.SetBody(0 , CODE_GETFLASH);
			    for(long i = 1; i < GET_FLASH_LEN; i++)
				{
				 embMsgUDRequest_8.SetBody(i , *pAddrData++);	//temporary
				}
		  		embMsgUDRequest_8.CalcCRC();
				embMsgUDRequest_8.SetReadyToSend();
}
...
extern "C" void  SetFlash7(char *pAddrData)
{
  WriteStatus7 = 0;
				embMsgUDRequest_7.Init();
				embMsgUDRequest_7.SetAddr(0);//emgUDRequest_1.Init();
 		     	embMsgUDRequest_7.SetLength(FLASH_LEN); //em
				embMsgUDRequest_7.SetBody(0 , CODE_SETFLASH);
			    for(long i = 1; i < FLASH_LEN; i++)
				{
				 embMsgUDRequest_7.SetBody(i , *pAddrData++);	//temporary
				}
...
extern "C" void  SetFlash8(char *pAddrData)
{
  WriteStatus8 = 0;
				embMsgUDRequest_8.Init();
				embMsgUDRequest_8.SetAddr(0);//emgUDRequest_1.Init();
 		     	embMsgUDRequest_8.SetLength(FLASH_LEN); //em
				embMsgUDRequest_8.SetBody(0 , CODE_SETFLASH);
			    for(long i = 1; i < FLASH_LEN; i++)
				{
				 embMsgUDRequest_8.SetBody(i , *pAddrData++);	//temporary
				}
...
//  printfpd("%d ",fl8);
    ...
    switch(inportb(POWER_PORT))
 {
  case CH1_MASK:  if(fl1) AlarmPmOff();
		   else	 AlarmPmOn();
		   break;
  case CH2_MASK:  if(fl2) AlarmPmOff();
		   else	 AlarmPmOn();
		   break;
  case CH3_MASK:  if(fl3) AlarmPmOff();
		   else	 AlarmPmOn();
		   break;

  case CH4_MASK:  if(fl4) AlarmPmOff();
		   else	 AlarmPmOn();
		   break;

  case CH5_MASK:  if(fl5) AlarmPmOff();
		   else	 AlarmPmOn();
		   break;

  case CH6_MASK:  if(fl6) AlarmPmOff();
		   else	 AlarmPmOn();
		   break;

  case CH7_MASK:  if(fl7) AlarmPmOff();
		   else	 AlarmPmOn();
		   break;

  case CH8_MASK:  if(fl8) AlarmPmOff();
		   else	 AlarmPmOn();
		   break;


//091113  default: AlarmPmOff(); 
  default: AlarmPmOff();  //091113
 }
}
...
switch(channel)
{
 ...
 case 4:  outportb(POWER_PORT, CH4_MASK);  break;
 case 5:  outportb(POWER_PORT, CH5_MASK);  break;
 case 6:  outportb(POWER_PORT, CH6_MASK);  break;
 case 7:  outportb(POWER_PORT, CH7_MASK);  break;
 case 8:  outportb(POWER_PORT, CH8_MASK);  break;
...
if(start3){ delay3 = ROULETTE_DELAY;}
   switch(requestPower++)
 {
   ...
   default :  	if(start3)
				...
				ClearMod();
#endif
   			    outportb(POWER_PORT, CH4_MASK);     // : need get on power on 4
				requestPower = 11;
				delay3 = NO_SCAN_DELAY;
				delay4 = time1 + START_TIMEOUT;
				start3 = 0;
				}
				else
				{
...
if(start4){ delay4 = ROULETTE_DELAY;}
   switch(requestTransit4++)
 {
   ...
   default :  	if(start4)
				{
#ifdef PROG_PRM_PCH_S
			   	ClearMod();//ClearTransit();
#endif
   				outportb(POWER_PORT, CH5_MASK);  
				requestTransit4 = 11;
				start4 = 0;
				delay4 = NO_SCAN_DELAY;
...
#endif
   			  //  printfp("\n\r set on power7");
   			    outportb(POWER_PORT, CH7_MASK);  	  //need correct : need get on power on 7
				requestTransit6 = 11;
				delay6 = NO_SCAN_DELAY;
				delay7 = time1 + START_TIMEOUT;
...
//____________________________________________________________________________>>_7


extern "C" void ParseUD_7()	 //need make!
{
...
if(modescan7)
 ...
 if(curval7 >= 0)
 {
   emb5StatusFrequScan7.emb5statusfrequscan.level[curval7] = ConvVal( (((unsigned short)embMsgUD_7.Body(2)&0x0F) << 8) + 	embMsgUD_7.Body(1));
 }
 else
 {
  }
 ...
 {
// printfp("\n\r   SET | 2 _________\n\r");
 unEmb2TypeVer.emb2TypeVer.signature_hardware[11] |= 2; //have power on 7	 //NEED CORRECT!!!
 } 

 switch(embMsgUD_7.Body(0))
 {
  case 0:// if(start6)
//  { unEmb2TypeVer.emb2TypeVer.signature_hardware[5] = embMsgUD_6.Body(1) & DEVICE_TYPE_MASK; 
//  		  Band6 = embMsgUD_6.Body(1); }	break;	   //hardvare 0
  {    	    Band7 = embMsgUD_7.Body(1);
		    Band72 = embMsgUD_7.Body(2);
			 tmp = embMsgUD_7.Body(1) & (unsigned char)DEVICE_TYPE_MASK;
	  //		  printEthLongHex(tmp); //0x21

       //	   	if(embMsgUD_2.Body(1) & (unsigned char)DEVICE_TYPE_MASK == (unsigned char)DEVICE_TYPE_MASK)
		   	if(tmp == (unsigned char)DEVICE_TYPE_MASK)
//    	   	if(embMsgUD_7.Body(1) & DEVICE_TYPE_MASK == DEVICE_TYPE_MASK)
			{
		  	 unEmb2TypeVer.emb2TypeVer.signature_hardware[14] = 			 //
		  	 (embMsgUD_7.Body(1) & DEVICE_TYPE_MASK) | ((embMsgUD_7.Body(2) & 0xF) << 2);
			}
			else
			{
			  unEmb2TypeVer.emb2TypeVer.signature_hardware[14] = embMsgUD_7.Body(1) & DEVICE_TYPE_MASK;
			}
  ...
  case 5:
  case 6:
  case 20:	unEmb2TypeVer.emb2TypeVer.signature_software[14] =  MakeAttBack(embMsgUD_7.Body(3));	break; //140718	  NEED CORRECT!
  case 21: 	emb5StatusReciever7.emb5statusreciever.status =  embMsgUD_7.Body(2) >> 4;
			emb5StatusReciever7.emb5statusreciever.signalLevel =  ConvVal( (((unsigned short)embMsgUD_7.Body(2)&0x0F)  << 8) + 	embMsgUD_7.Body(1));
 		   	emb5StatusReciever7.emb5statusreciever.stepAtt =  MakeAttBack(embMsgUD_7.Body(3));  //	break;
			break;	   //for test
  case 22:	emb5RPUState7.emb5rpustate.temp =  embMsgUD_7.Body(1);
			emb5RPUState7.emb5rpustate.temp_min =  embMsgUD_7.Body(2);
			emb5RPUState7.emb5rpustate.temp_max =  embMsgUD_7.Body(3);
  case 23:	emb5RPUState7.emb5rpustate.u48 =  embMsgUD_7.Body(1);
			emb5RPUState7.emb5rpustate.u48min =  embMsgUD_7.Body(2);
			emb5RPUState7.emb5rpustate.u48max =  embMsgUD_7.Body(3);
  case 24:	emb5RPUState7.emb5rpustate.u24 =  embMsgUD_7.Body(1);
			emb5RPUState7.emb5rpustate.u24min =  embMsgUD_7.Body(2);
			emb5RPUState7.emb5rpustate.u24max =  embMsgUD_7.Body(3);
  case 25:	emb5RPUState7.emb5rpustate.u7 =  embMsgUD_7.Body(1);
			emb5RPUState7.emb5rpustate.u7min =  embMsgUD_7.Body(2);
			emb5RPUState7.emb5rpustate.u7max =  embMsgUD_7.Body(3);
  case 26:	emb5RPUState7.emb5rpustate.u5 =  embMsgUD_7.Body(1);
			emb5RPUState7.emb5rpustate.u5min =  embMsgUD_7.Body(2);
			emb5RPUState7.emb5rpustate.u5max =  embMsgUD_7.Body(3);
  case 27:	emb5RPUState7.emb5rpustate.u_5 =  embMsgUD_7.Body(1);
			emb5RPUState7.emb5rpustate.u_5min =  embMsgUD_7.Body(2);
			emb5RPUState7.emb5rpustate.u_5max =  embMsgUD_7.Body(3);
#ifdef PROG_PRM_PCH_L_61
  case 28: break;//	unEmb2TypeVer.emb2TypeVer.signature_software[5] =  embMsgUD_7.Body(1);	break;
  case 29:	/*unEmb2TypeVer.emb2TypeVer.signature_software[7] =  embMsgUD_7.Body(1); */	break;	//need correct

  case 30:	WriteStatus7 = embMsgUD_7.Body(1); break;
  case 31:	ReadStatus7[0] = embMsgUD_7.Body(1); 
			ReadStatus7[1] = embMsgUD_7.Body(2); 
			ReadStatus7[2] = embMsgUD_7.Body(3); break;
  case 32:	ReadAtt7[0] = embMsgUD_7.Body(1); 
			ReadAtt7[1] = embMsgUD_7.Body(2); 
			ReadAtt7[2] = embMsgUD_7.Body(3); break;
...
extern "C" void MakeNextStepScan7()
{
// SetFreq7();
 ...
 if(emb5ScanFreq7.emb5scanfreq.numOfStep--)
 {
   emb5CommandRecieverSetFrequ7.emb5commandrecieversetfrequ.frequ += emb5ScanFreq7.emb5scanfreq.step;
   emb5StatusReciever7.emb5statusreciever.frequ =  emb5CommandRecieverSetFrequ7.emb5commandrecieversetfrequ.frequ;
   curval7++;
 }
 else
 {
 modescan7 = 0; //start scan channel2
 delay7 = NO_SCAN_DELAY;
 }
}
...
//unsigned char tmp;
//#ifdef PRM_PCH_DEBUG
 //printfpd("\n\rroulette7 code: %d" , requestTransit7);
//#endif// PRM_PCH_DEBUG
  if(start7){ delay7 = ROULETTE_DELAY;}
   switch(requestTransit7++)
 {
   case 0: GetCode7();	break;
   case 1: GetCode7();	break;//GetLockLevel6();    		break;
   case 2: GetCode7();	break;//GetTemp6(); break;
   case 3: GetCode7();	break;//Get48_6(); break;
   case 4: GetCode7();	break;//Get24_6(); break;
   case 5: GetCode7();	break;//Get7_6();break;
   case 6: GetCode7();	break;//Get5_6(); break;
   case 7: GetCode7(); 	break;//Get5M_6(); break;
   case 9: if(!setf7) {SetFreq7(); setf7 = 1; break;} 	 return 0;
   case 8: if(!setatt7) {SetAtt7(); setatt7 = 1;  break;}    return 0;
   default :  	if(start7)
				{
#ifdef PROG_PRM_PCH_S
				ClearMod(); //   ClearTransit();
#endif
   			    outportb(POWER_PORT, CH8_MASK);  	    //need correct : need get on power on 8

				requestTransit7 = 11;
				delay7 = NO_SCAN_DELAY;
				delay8 = time1 + START_TIMEOUT;
...
unsigned char * b = Formula9(emb5CommandRecieverSetFrequ7.emb5commandrecieversetfrequ.frequ,Band7, Band72);
 
unsigned long *get1 = (unsigned long*)&b[16]; 
unsigned long *get2 = (unsigned long*)&b[20]; 
uemb5statusgeterodin7.emb5statusgeterodin.frequ	= 10l * emb5CommandRecieverSetFrequ7.emb5commandrecieversetfrequ.frequ;
uemb5statusgeterodin7.emb5statusgeterodin.get1 = *get1;
uemb5statusgeterodin7.emb5statusgeterodin.get2 = *get2;
 ...
 if((b2_keep & 0xf) != (b[2] & 0xf))
 {
	b2_keep = b[2]; timewait = (unsigned long)LONG_RUN_TIME;
				...
				embMsgUDRequest_7.Init();
				embMsgUDRequest_7.SetAddr(0);//embMsg.Body(0));
				embMsgUDRequest_7.SetLength(FORMULA_LEN); //?????
				for(long i = 0; i < FORMULA_LEN; i++)
				{
  				 embMsgUDRequest_7.SetBody(i,  b[i]);	//temporary
				}
		  		embMsgUDRequest_7.CalcCRC();
				embMsgUDRequest_7.SetReadyToSend();
}
extern "C" void  SetAtt7()
{

				embMsgUDRequest_7.Init();
				embMsgUDRequest_7.SetAddr(0);//embMsg.Body(0));
				embMsgUDRequest_7.SetLength(2); //?????
				embMsgUDRequest_7.SetBody(0,CODE_SET_ATT);	//
			    embMsgUDRequest_7.SetBody(1, emb5CommandRecieverSetAtt7.emb5commandrecieversetatt.stepAtt);	//
		  		embMsgUDRequest_7.CalcCRC();
				embMsgUDRequest_7.SetReadyToSend();
}

extern "C" void  GetCode7()
{
	//	printfp("\n\r GetCode7");
 				embMsgUDRequest_7.Init();
				embMsgUDRequest_7.SetAddr(0);//
				embMsgUDRequest_7.SetLength(1); //?????
				embMsgUDRequest_7.SetBody(0,CODE_CODE);	//
			   	embMsgUDRequest_7.CalcCRC();
				embMsgUDRequest_7.SetReadyToSend();
 //	if(embMsgUDRequest_7.IsReadyToSend())
 //	{
...
extern "C" void  GetLockLevel7()
{
				embMsgUDRequest_7.Init();
				embMsgUDRequest_7.SetAddr(0);//
				embMsgUDRequest_7.SetLength(1); //?????
				embMsgUDRequest_7.SetBody(0,CODE_LOCK_LEVEL);	//
			   	embMsgUDRequest_7.CalcCRC();
				embMsgUDRequest_7.SetReadyToSend();
}


extern "C" void  GetTemp7()
{
				embMsgUDRequest_7.Init();
				embMsgUDRequest_7.SetAddr(0);//
				embMsgUDRequest_7.SetLength(1); //?????
				embMsgUDRequest_7.SetBody(0,CODE_TEMP);	//
			   	embMsgUDRequest_7.CalcCRC();
				embMsgUDRequest_7.SetReadyToSend();
}


extern "C" void  Get48_7()
{
				embMsgUDRequest_7.Init();
				embMsgUDRequest_7.SetAddr(0);//
				embMsgUDRequest_7.SetLength(1); //?????
				embMsgUDRequest_7.SetBody(0,CODE_48);	//
			   	embMsgUDRequest_7.CalcCRC();
				embMsgUDRequest_7.SetReadyToSend();
}

extern "C" void  Get24_7()
{
				embMsgUDRequest_7.Init();
				embMsgUDRequest_7.SetAddr(0);//
				embMsgUDRequest_7.SetLength(1); //?????
				embMsgUDRequest_7.SetBody(0,CODE_24);	//
			   	embMsgUDRequest_7.CalcCRC();
				embMsgUDRequest_7.SetReadyToSend();
}


extern "C" void  Get7_7()
{
				embMsgUDRequest_7.Init();
				embMsgUDRequest_7.SetAddr(0);//
				embMsgUDRequest_7.SetLength(1); //?????
				embMsgUDRequest_7.SetBody(0,CODE_7);	//
			   	embMsgUDRequest_7.CalcCRC();
				embMsgUDRequest_7.SetReadyToSend();
}

extern "C" void  Get5_7()
{
				embMsgUDRequest_7.Init();
				embMsgUDRequest_7.SetAddr(0);//
				embMsgUDRequest_7.SetLength(1); //?????
				embMsgUDRequest_7.SetBody(0,CODE_5);	//
			   	embMsgUDRequest_7.CalcCRC();
				embMsgUDRequest_7.SetReadyToSend();
}

extern "C" void  Get5M_7()
{
				embMsgUDRequest_7.Init();
				embMsgUDRequest_7.SetAddr(0);//
				embMsgUDRequest_7.SetLength(1); //?????
				embMsgUDRequest_7.SetBody(0,CODE_5M);	//
			   	embMsgUDRequest_7.CalcCRC();
				embMsgUDRequest_7.SetReadyToSend();
}
//___________________________________________________________________________________7

//____________________________________________________________________________>>_8


extern "C" void ParseUD_8()	 //need make!
{
unsigned char tmp;
if(modescan8)
 {
 if(curval8 >= 0)
 {
   emb5StatusFrequScan6.emb5statusfrequscan.level[curval8] = ConvVal( (((unsigned short)embMsgUD_8.Body(2)&0x0F) << 8) + 	embMsgUD_8.Body(1));
 }
 else
 {
  }
 ...
 if(start8) //100401
 unEmb2TypeVer.emb2TypeVer.signature_hardware[7] |= 2; //have power on 8	   NEED CORRECT!!!
 

 switch(embMsgUD_8.Body(0))
 {
  case 0:// if(start6)
//  { unEmb2TypeVer.emb2TypeVer.signature_hardware[5] = embMsgUD_8.Body(1) & DEVICE_TYPE_MASK; 
//  		  Band6 = embMsgUD_8.Body(1); }	break;	   //hardvare 0
  {    	    Band8 = embMsgUD_8.Body(1);
		    Band82 = embMsgUD_8.Body(2);
			 tmp = embMsgUD_8.Body(1) & (unsigned char)DEVICE_TYPE_MASK;
	  //		  printEthLongHex(tmp); //0x21

       //	   	if(embMsgUD_2.Body(1) & (unsigned char)DEVICE_TYPE_MASK == (unsigned char)DEVICE_TYPE_MASK)
		   	if(tmp == (unsigned char)DEVICE_TYPE_MASK)
//    	   	if(embMsgUD_8.Body(1) & DEVICE_TYPE_MASK == DEVICE_TYPE_MASK)
			{
		  	 unEmb2TypeVer.emb2TypeVer.signature_hardware[15] = 
		  	 (embMsgUD_8.Body(1) & DEVICE_TYPE_MASK) | ((embMsgUD_8.Body(2) & 0xF) << 2);  //
			}
			else
			{
			  unEmb2TypeVer.emb2TypeVer.signature_hardware[15] = embMsgUD_8.Body(1) & DEVICE_TYPE_MASK;
			}
  ...
  case 5:
  case 6:
  case 20:	unEmb2TypeVer.emb2TypeVer.signature_software[15] =  MakeAttBack(embMsgUD_8.Body(3));	break; //140718	 NEED CORRECT!
  case 21: 	emb5StatusReciever8.emb5statusreciever.status =  embMsgUD_8.Body(2) >> 4;
			emb5StatusReciever8.emb5statusreciever.signalLevel =  ConvVal( (((unsigned short)embMsgUD_8.Body(2)&0x0F)  << 8) + 	embMsgUD_8.Body(1));
 		   	emb5StatusReciever8.emb5statusreciever.stepAtt =  MakeAttBack(embMsgUD_8.Body(3));  //	break;
			break;	   //for test
  case 22:	emb5RPUState8.emb5rpustate.temp =  embMsgUD_8.Body(1);
			emb5RPUState8.emb5rpustate.temp_min =  embMsgUD_8.Body(2);
			emb5RPUState8.emb5rpustate.temp_max =  embMsgUD_8.Body(3);
  case 23:	emb5RPUState8.emb5rpustate.u48 =  embMsgUD_8.Body(1);
			emb5RPUState8.emb5rpustate.u48min =  embMsgUD_8.Body(2);
			emb5RPUState8.emb5rpustate.u48max =  embMsgUD_8.Body(3);
  case 24:	emb5RPUState8.emb5rpustate.u24 =  embMsgUD_8.Body(1);
			emb5RPUState8.emb5rpustate.u24min =  embMsgUD_8.Body(2);
			emb5RPUState8.emb5rpustate.u24max =  embMsgUD_8.Body(3);
  case 25:	emb5RPUState8.emb5rpustate.u7 =  embMsgUD_8.Body(1);
			emb5RPUState8.emb5rpustate.u7min =  embMsgUD_8.Body(2);
			emb5RPUState8.emb5rpustate.u7max =  embMsgUD_8.Body(3);
  case 26:	emb5RPUState8.emb5rpustate.u5 =  embMsgUD_8.Body(1);
			emb5RPUState8.emb5rpustate.u5min =  embMsgUD_8.Body(2);
			emb5RPUState8.emb5rpustate.u5max =  embMsgUD_8.Body(3);
  case 27:	emb5RPUState8.emb5rpustate.u_5 =  embMsgUD_8.Body(1);
			emb5RPUState8.emb5rpustate.u_5min =  embMsgUD_8.Body(2);
			emb5RPUState8.emb5rpustate.u_5max =  embMsgUD_8.Body(3);
#ifdef PROG_PRM_PCH_L_61
  case 28: break;//	unEmb2TypeVer.emb2TypeVer.signature_software[5] =  embMsgUD_8.Body(1);	break;
  case 29: /*	unEmb2TypeVer.emb2TypeVer.signature_software[7] =  embMsgUD_8.Body(1); */	break;

  case 30:	WriteStatus8 = embMsgUD_8.Body(1); break;
  case 31:	ReadStatus8[0] = embMsgUD_8.Body(1); 
			ReadStatus8[1] = embMsgUD_8.Body(2); 
			ReadStatus8[2] = embMsgUD_8.Body(3); break;
  case 32:	ReadAtt8[0] = embMsgUD_8.Body(1); 
			ReadAtt8[1] = embMsgUD_8.Body(2); 
			ReadAtt8[2] = embMsgUD_8.Body(3); break;
...
extern "C" void MakeNextStepScan8()
{
 //SetFreq8();
 ...
 if(emb5ScanFreq8.emb5scanfreq.numOfStep--)
 {
   emb5CommandRecieverSetFrequ8.emb5commandrecieversetfrequ.frequ += emb5ScanFreq8.emb5scanfreq.step;
   emb5StatusReciever8.emb5statusreciever.frequ =  emb5CommandRecieverSetFrequ8.emb5commandrecieversetfrequ.frequ;
   curval8++;
 }
 else
 {
 modescan8 = 0; //start scan channel2
 delay8 = NO_SCAN_DELAY;
 }
}
...
// printf("\n\rroulette6 code: %d" , requestTransit6);
#endif// PRM_PCH_DEBUG
  if(start8){ delay8 = ROULETTE_DELAY;}
   switch(requestTransit8++)
 {
   case 0: GetCode8();	break;
   case 1: GetCode8();	break;//GetLockLevel6();    		break;
   case 2: GetCode8();	break;//GetTemp6(); break;
   case 3: GetCode8();	break;//Get48_6(); break;
   case 4: GetCode8();	break;//Get24_6(); break;
   case 5: GetCode8();	break;//Get7_6();break;
   case 6: GetCode8();	break;//Get5_6(); break;
   case 7: GetCode8(); 	break;//Get5M_6(); break;
   case 9: if(!setf8) {SetFreq8(); setf8 = 1; break;} 	 return 0;
   case 8: if(!setatt8) {SetAtt8(); setatt8 = 1;  break;}    return 0;
   default :  	if(start8)
				{
#ifdef PROG_PRM_PCH_S
				ClearMod(); //   ClearTransit();
#endif
   			    outportb(POWER_PORT, 0);  	 //all pewer off
				requestTransit8 = 11;
				delay8 = NO_SCAN_DELAY;
				start8 = 0;
				}
...
unsigned char * b = Formula9(emb5CommandRecieverSetFrequ8.emb5commandrecieversetfrequ.frequ,Band8, Band82);
 
unsigned long *get1 = (unsigned long*)&b[16]; 
unsigned long *get2 = (unsigned long*)&b[20]; 
uemb5statusgeterodin8.emb5statusgeterodin.frequ	= 10l * emb5CommandRecieverSetFrequ8.emb5commandrecieversetfrequ.frequ;
uemb5statusgeterodin8.emb5statusgeterodin.get1 = *get1;
uemb5statusgeterodin8.emb5statusgeterodin.get2 = *get2;
 ...
 if((b2_keep & 0xf) != (b[2] & 0xf))
 {
	b2_keep = b[2]; timewait = (unsigned long)LONG_RUN_TIME;
				...
				embMsgUDRequest_8.Init();
				embMsgUDRequest_8.SetAddr(0);//embMsg.Body(0));
				embMsgUDRequest_8.SetLength(FORMULA_LEN); //?????
				for(long i = 0; i < FORMULA_LEN; i++)
				{
  				 embMsgUDRequest_8.SetBody(i,  b[i]);	//temporary
				}
		  		embMsgUDRequest_8.CalcCRC();
				embMsgUDRequest_8.SetReadyToSend();
}
extern "C" void  SetAtt8()
{

				embMsgUDRequest_8.Init();
				embMsgUDRequest_8.SetAddr(0);//embMsg.Body(0));
				embMsgUDRequest_8.SetLength(2); //?????
				embMsgUDRequest_8.SetBody(0,CODE_SET_ATT);	//
			    embMsgUDRequest_8.SetBody(1, emb5CommandRecieverSetAtt8.emb5commandrecieversetatt.stepAtt);	//
		  		embMsgUDRequest_8.CalcCRC();
				embMsgUDRequest_8.SetReadyToSend();
}

extern "C" void  GetCode8()
{
 			embMsgUDRequest_8.Init();
				embMsgUDRequest_8.SetAddr(0);//
				embMsgUDRequest_8.SetLength(1); //?????
				embMsgUDRequest_8.SetBody(0,CODE_CODE);	//
			   	embMsgUDRequest_8.CalcCRC();
				embMsgUDRequest_8.SetReadyToSend();
}

extern "C" void  GetLockLevel8()
{
				embMsgUDRequest_8.Init();
				embMsgUDRequest_8.SetAddr(0);//
				embMsgUDRequest_8.SetLength(1); //?????
				embMsgUDRequest_8.SetBody(0,CODE_LOCK_LEVEL);	//
			   	embMsgUDRequest_8.CalcCRC();
				embMsgUDRequest_8.SetReadyToSend();
}


extern "C" void  GetTemp8()
{
				embMsgUDRequest_8.Init();
				embMsgUDRequest_8.SetAddr(0);//
				embMsgUDRequest_8.SetLength(1); //?????
				embMsgUDRequest_8.SetBody(0,CODE_TEMP);	//
			   	embMsgUDRequest_8.CalcCRC();
				embMsgUDRequest_8.SetReadyToSend();
}


extern "C" void  Get48_8()
{
				embMsgUDRequest_8.Init();
				embMsgUDRequest_8.SetAddr(0);//
				embMsgUDRequest_8.SetLength(1); //?????
				embMsgUDRequest_8.SetBody(0,CODE_48);	//
			   	embMsgUDRequest_8.CalcCRC();
				embMsgUDRequest_8.SetReadyToSend();
}

extern "C" void  Get24_8()
{
				embMsgUDRequest_8.Init();
				embMsgUDRequest_8.SetAddr(0);//
				embMsgUDRequest_8.SetLength(1); //?????
				embMsgUDRequest_8.SetBody(0,CODE_24);	//
			   	embMsgUDRequest_8.CalcCRC();
				embMsgUDRequest_8.SetReadyToSend();
}


extern "C" void  Get7_8()
{
				embMsgUDRequest_8.Init();
				embMsgUDRequest_8.SetAddr(0);//
				embMsgUDRequest_8.SetLength(1); //?????
				embMsgUDRequest_8.SetBody(0,CODE_7);	//
			   	embMsgUDRequest_8.CalcCRC();
				embMsgUDRequest_8.SetReadyToSend();
}

extern "C" void  Get5_8()
{
				embMsgUDRequest_8.Init();
				embMsgUDRequest_8.SetAddr(0);//
				embMsgUDRequest_8.SetLength(1); //?????
				embMsgUDRequest_8.SetBody(0,CODE_5);	//
			   	embMsgUDRequest_8.CalcCRC();
				embMsgUDRequest_8.SetReadyToSend();
}

extern "C" void  Get5M_8()
{
				embMsgUDRequest_8.Init();
				embMsgUDRequest_8.SetAddr(0);//
				embMsgUDRequest_8.SetLength(1); //?????
				embMsgUDRequest_8.SetBody(0,CODE_5M);	//
			   	embMsgUDRequest_8.CalcCRC();
				embMsgUDRequest_8.SetReadyToSend();
}
...
case 4:    return unEmb2TypeVer.emb2TypeVer.signature_software[12];
case 5:    return unEmb2TypeVer.emb2TypeVer.signature_software[12];
case 6:    return unEmb2TypeVer.emb2TypeVer.signature_software[12];
case 7:    return unEmb2TypeVer.emb2TypeVer.signature_software[12];
case 8:    return unEmb2TypeVer.emb2TypeVer.signature_software[12];
...
case 6:	   emb5CommandRecieverSetFrequ6.emb5commandrecieversetfrequ.frequ = val;
   		   emb5StatusReciever6.emb5statusreciever.frequ =  emb5CommandRecieverSetFrequ6.emb5commandrecieversetfrequ.frequ;
		   break;
case 7:	   emb5CommandRecieverSetFrequ7.emb5commandrecieversetfrequ.frequ = val;
   		   emb5StatusReciever7.emb5statusreciever.frequ =  emb5CommandRecieverSetFrequ7.emb5commandrecieversetfrequ.frequ;
		   break;
case 8:	   emb5CommandRecieverSetFrequ8.emb5commandrecieversetfrequ.frequ = val;
   		   emb5StatusReciever8.emb5statusreciever.frequ =  emb5CommandRecieverSetFrequ8.emb5commandrecieversetfrequ.frequ;
		   break;
...
case 6:	    emb5CommandRecieverSetAtt6.emb5commandrecieversetatt.stepAtt =  val;
   	 //		emb5StatusReciever3.emb5statusreciever.stepAtt =  emb5CommandRecieverSetAtt3.emb5commandrecieversetatt.stepAtt;   
 	   		break;
case 7:	    emb5CommandRecieverSetAtt7.emb5commandrecieversetatt.stepAtt =  val;
   	 //		emb5StatusReciever3.emb5statusreciever.stepAtt =  emb5CommandRecieverSetAtt3.emb5commandrecieversetatt.stepAtt;   
 	   		break;
case 8:	    emb5CommandRecieverSetAtt8.emb5commandrecieversetatt.stepAtt =  val;
   	 //		emb5StatusReciever3.emb5statusreciever.stepAtt =  emb5CommandRecieverSetAtt3.emb5commandrecieversetatt.stepAtt;   
 	   		break;
...
case 7:	    emb5CommandRPUSetAtt7.emb5commandrpusetatt.stepAtt =  val;
			unEmb2TypeVer.emb2TypeVer.signature_hardware[12] = val;
	  //		SetAttRPU3();
			unEmb2TypeVer.emb2TypeVer.signature_software[12] = val;
 	   		break;
...
case 8:	    emb5CommandRPUSetAtt7.emb5commandrpusetatt.stepAtt =  val;
			unEmb2TypeVer.emb2TypeVer.signature_hardware[12] = val;
	  //		SetAttRPU3();
			unEmb2TypeVer.emb2TypeVer.signature_software[12] = val;
 	   		break;
...
case 7:    return emb5CommandRecieverSetFrequ7.emb5commandrecieversetfrequ.frequ;
case 8:    return emb5CommandRecieverSetFrequ8.emb5commandrecieversetfrequ.frequ;
...
case 7:    return emb5CommandRecieverSetAtt7.emb5commandrecieversetatt.stepAtt;
case 8:    return emb5CommandRecieverSetAtt8.emb5commandrecieversetatt.stepAtt;
...
extern "C" unsigned char device_found(unsigned char channel)
{
 switch(channel)
 {
  ...
  case 7 : /*if(unEmb2TypeVer.emb2TypeVer.signature_hardware[7]) */	 return 1;	 //need make protokol!!!!
  case 8 :/* if(unEmb2TypeVer.emb2TypeVer.signature_hardware[7]) */	 return 1;	 //need make protokol!!!!
