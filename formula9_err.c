...
//				if((f_in>=1770000)&&(f_in<1912000)) b[1]=0x01;  // ошибка блока Жени переключение генератора время
//				if((f_in>=1912000)&&(f_in<2075000)) b[1]=0x04;	 // ошибка блока Жени переключение генератора время
//				if((f_in>=2075000)&&(f_in<2247000)) b[1]=0x10;	 // ошибка блока Жени переключение генератора время	
//				if((f_in>=2247000)&&(f_in<2433000)) b[1]=0x02;	 // ошибка блока Жени переключение генератора время	
//				if((f_in>=2433000)&&(f_in<2650000)) b[1]=0x08; // ошибка блока Жени переключение генератора время
...
//			if((f_in>=260000)&&(f_in<1020000)) b[1]=0x02;  // ошибка блока Жени переключение генератора время
//			if((f_in>=1020000)&&(f_in<1770000)) b[1]=0x01; // ошибка блока Жени переключение генератора время	
...
//			if((f_in>=2650000)&&(f_in<2790000)) b[1]=0x02;  // ошибка блока Жени переключение генератора время
//			if((f_in>=2790000)&&(f_in<2940000)) b[1]=0x20; // ошибка блока Жени переключение генератора время	
//			if((f_in>=2940000)&&(f_in<3100000)) b[1]=0x01; // ошибка блока Жени переключение генератора время	
//			if((f_in>=3100000)&&(f_in<3265000)) b[1]=0x10; // ошибка блока Жени переключение генератора время		
//			if((f_in>=3265000)&&(f_in<3440000)) b[1]=0x40; // ошибка блока Жени переключение генератора время
//			if((f_in>=3440000)&&(f_in<3620000)) b[1]=0x80; // ошибка блока Жени переключение генератора время		
//			if((f_in>=3620000)&&(f_in<3810000)) b[1]=0x04; // ошибка блока Жени переключение генератора время		
//			if((f_in>=3810000)&&(f_in<4010000)) b[1]=0x08; // ошибка блока Жени переключение генератора время
