...
//		unEmb2TypeVer.emb2TypeVer.signature_hardware[2] = inportb(0x514);
		...
		unEmb2TypeVer.emb2TypeVer.signature_hardware[7] = 0; // reserv
		unEmb2TypeVer.emb2TypeVer.signature_hardware[8] = 0; // reserv
...
//		unEmb2TypeVer.emb2TypeVer.signature_hardware[2] = inportb(0x514);
		...
		unEmb2TypeVer.emb2TypeVer.signature_hardware[6] = inportb(0x515);
#ifdef OP_TRUNKS
		unEmb2TypeVer.emb2TypeVer.signature_hardware[7] = dev_status; //0;//inportb(0x507); // reserv
#else
...
// #include answerpumv.inc
   

//#include checkremotemodv.inc		//t
//#include answerpumv.inc		   //t
...
//#else
   //		embSerialACT155.Init();
//#endif	//no FULL_TEST_TRANZIT




// outport(0x506,0xff); //090413
}
//outport(wdtcon,0x5555);
//outport(wdtcon,0xaaaa);
