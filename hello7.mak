...
hello7.elf:  hello7.o asm_test.o work.o at45.o work1.o jump.o EMBISR.o ttl.o hello.o dataflash.o spi_pol.o utils.o endian.o hostDriverForPc.o PVG610_API.o md310e.o rtcs.a atevbrm9200.a mqx.a libc.a met.o
	@echo Linking...  
...
-include C:\ARC\mqx2.50_atevbrm9200.met\examples\hello7\md310e.d

md310e.o:
	@echo Compiling C:\\ARC\\mqx2.50_atevbrm9200.met\\examples\\hello7\\md310e.cpp ...  
	@$(CC) -Hnocopyr -c -Hasopt=-c @C:\ARC\mqx2.50_atevbrm9200.met\examples\hello7\hello7.opc C:\ARC\mqx2.50_atevbrm9200.met\examples\hello7\md310e.cpp
