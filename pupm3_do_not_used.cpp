...
//printfpd(".. %d", time1);
 ...
 timer = time1;
//130524 address inthid device is olwais zero as at start ReadAddress();
 /*
#ifdef TEST_PRINT_SPI
...
// ????
 #include checkremotepupm3.c
 #include answerpupm3.c
...
unsigned char Data[] = {0xFE,0xFE,0x44,0,0,01,02,0x47,0xFC,0xFC};	vol = 10; //command 44  2 byte
//unsigned char Data[] = {0xFE,0xFE,0x44,0,0,01,02,0x49,0xFC,0xFC};	vol = 10; //command 44  2 byte
//unsigned char Data[] = {0xFE,0xFE,0x44,0,0x10,01,02,00,0x59,0xFC,0xFC};	vol = 11; //command 44  3 byte
//okunsigned char Data[] = {0xFE,0xFE,0x43,0,0,3,0x46,0xFC,0xFC};	vol = 9; //command 43  1 byte
//unsigned char Data[] = {0xFE,0xFE,0x48,0,0,3,0x4D,0xFC,0xFC};	vol = 9; //command 48 read 4 bytes
//unsigned char Data[] = {0xFE,0xFE,0x48,0,0,6,0x50,0xFC,0xFC};	vol = 9; //command 48 read 7 bytes
//okunsigned char Data[] = {0xFE,0xFE,0x48,0,0,0x18,0x60,0xFC,0xFC};	vol = 9; //command 48 read 0x19 bytes, addr = 0
