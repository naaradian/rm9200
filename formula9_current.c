...
//	double temp_dbl;
	...
	if((f_in<1770000))
	{
		if(ver==5)
	  {
			...
			if((f_in>=1000000)&&(f_in<1020000)) att=2;
			if((f_in>=1020000)&&(f_in<1030000)) att=8;
			if((f_in>=1030000)&&(f_in<1120000)) att=8;
			if((f_in>=1120000)&&(f_in<1210000)) att=9;
			if((f_in>=1210000)&&(f_in<1280000)) att=9;
			if((f_in>=1280000)&&(f_in<1300000)) att=8;
			if((f_in>=1300000)&&(f_in<1340000)) att=9;
			if((f_in>=1340000)&&(f_in<1390000)) att=10;
			if((f_in>=1390000)&&(f_in<1490000)) att=11;
			if((f_in>=1490000)&&(f_in<1640000)) att=8;
			if((f_in>=1640000)&&(f_in<1660000)) att=9;
			if((f_in>=1660000)&&(f_in<1700000)) att=7;
			if((f_in>=1700000)&&(f_in<1770000)) att=6;	  
