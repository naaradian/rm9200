...
extern "C" void enableRxPdcSPI1(void);
extern "C" void enableTxPdcSPI1();
...
void EmbMsgN::SetCommandN(unsigned long pos)
{
 switch(body[pos++])
 {
  ...
  case 20	: RunCommandN20(pos); break;
  case 21	: RunCommandN21(body[pos],body[pos+1],body[pos+2],body[pos+3]); break;
#endif
#endif
...
unsigned char current_command_data[MAX_DATA_SIZE];

unsigned char current_answer_counter;
unsigned char current_answer_state;
unsigned char current_answer_type;
unsigned char current_answer_crc;
unsigned char current_answer_length;
unsigned char current_answer_data_counter;
unsigned char current_answer_data[MAX_DATA_SIZE];
unsigned char current_celling_crc;
...
unsigned long spi_counter_t, spi_counter_r;
#endif
unsigned char flag_add_tcp;
...
// return;
 ...
 ssc1_receive_state = 0;
 ssc1_receive_length = 0;
 #endif
...
if(NeedRunCommand)
{
  ...
  RunCommandSSC2();
		...
		*/
//test_send_data_spi();	//111019


//#ifdef TEST_TRANSMIT_FROM_SSC1
//#ifdef	 PROG_PRM_PCH_SPI_STEND // prm_pch_spi.cpp

//111019 test_send_data_SSC1();
...
{
   printfpd("\n\r %ld>", time1);
   printfpd("t: %ld ",spi_counter_t);
   printfpd("r: %ld ",spi_counter_r);
...
if(!(cntt1 % 2))
{
  OperateBuffers_SPI1_stend();	//and will have in interrupt
}
//#endif
//#endif
//#endif
...
extern "C" void PRM_PCH_old()
 {


//test_send_data_ssc2();
//set in transmit OperateBuffers_SSC2(); //temporary not in interrupt
return; //for test
...
//    }
 ...
 //  }
   ...
   */
		 /*
extern "C" void ToPdcTspi(unsigned char byte)
{
 embMsgSSC2.Add(byte);
}
 */
