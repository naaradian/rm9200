...
//{
	...
	unEmb2TypeVer.emb2TypeVer.type       = 0x0014;
...
//static long  cntprint;

  // err_tmp_now = 0x12345678;
 //  unStatePUM.statePUM.ulErrAfterRS1 += (long)err_tmp_now;

//if(!(cntprint++ %1000))
//{
//printfpd(" %X ",unStatePUM.statePUM.ulErrAfterRS1);
//printfpd(" %X ",err_tmp_now);
...
//printEthLongHex(unStatePUM.statePUM.ulErrBeforeRS1);
//okunStatePUM.statePUM.ulErrBeforeRS1 = 0x12345678l;
  //	 err_tmp_now = 0xFFFF;
  //	 unStatePUM.statePUM.ulErrBeforeRS1 += err_tmp_now;
 //  if(!(cntprint++ %1000))
 //	printfpd(" %X ",unStatePUM.statePUM.ulErrBeforeRS1);
...
printfp("\n\r unStatePUM.statePUM.ulErrOut :");
printfpd(" %ld", unStatePUM.statePUM.ulErrOut);


printfp("\n\r unStatePUM.statePUM.ulBlock :");
printfpd(" %ld", unStatePUM.statePUM.ulBlock);


printfp("\n\r unStatePUM.statePUM.ulErrAfterRS1 :");
printfpd(" %ld", unStatePUM.statePUM.ulErrAfterRS1);
printfp("\n\r unStatePUM.statePUM.ulErrAfterRS2 :");
printfpd(" %ld", unStatePUM.statePUM.ulErrAfterRS2);


printfp("\n\r unStatePUM.statePUM.ulErrBeforeRS1 :");
printfpd(" %ld", unStatePUM.statePUM.ulErrBeforeRS1);
printfp("\n\r unStatePUM.statePUM.ulErrBeforeRS2 :");
printfpd(" %ld", unStatePUM.statePUM.ulErrBeforeRS2);
