...
fl7=fl8=0; 
 requestTransit5 = 0; requestTransit6 = 0;
 start5 = 1;
 start6 = 1;
//_______________________________ ???
 mode5AWest2=0; 
...
//   	 	embMsgUDRequest_6.Init();
//#else  // COMMAND_RESENDING
	  if(modescan7)	embMsgUDRequest_7.Init();
//#endif //COMMAND_RESENDING
...
/*
 if(start7) //100401
 unEmb2TypeVer.emb2TypeVer.signature_hardware[7] = 1; //have power on 6	 //NEED CORRECT!!!
  */
