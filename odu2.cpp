...
// uProt[i].protection.CopyAcm = 0; //130226
  ...
  else if(protection_mode == MODE_1_PLUS_1)
  {
   ...
   {
    uProt[i].protection.ProtRx = 0;	   //protection	  none
...
void ModemP::CopyStruct(unsigned long variant)
{

configfilefext2[variant].ConfigTxtData.emb4md15504cfg.fileNum0 =
					 configfilefext1[variant].ConfigTxtData.emb4md15504cfg.conf_number;

configfilefext2[variant].ConfigTxtData.emb4md15504cfg.fileNum1 =
					 configfilefext1[variant].ConfigTxtData.emb4md15504cfg.conf_number1;



configfilefext2[variant].ConfigTxtData.emb4md15504cfg.numMode =
                 configfilefext1[variant].ConfigTxtData.emb4md15504cfg.numMode;


configfilefext2[variant].ConfigTxtData.emb4md15504cfg.numProvCode =
                 configfilefext1[variant].ConfigTxtData.emb4md15504cfg.numProvCode;


configfilefext2[variant].ConfigTxtData.emb4md15504cfg.rateSymbol0 =
                 configfilefext1[variant].ConfigTxtData.emb4md15504cfg.rateSymbol0;

configfilefext2[variant].ConfigTxtData.emb4md15504cfg.rateSymbol1 =
                 configfilefext1[variant].ConfigTxtData.emb4md15504cfg.rateSymbol1;

configfilefext2[variant].ConfigTxtData.emb4md15504cfg.rateSymbol2 =
                 configfilefext1[variant].ConfigTxtData.emb4md15504cfg.rateSymbol2;

configfilefext2[variant].ConfigTxtData.emb4md15504cfg.rateSymbol3 =
                 configfilefext1[variant].ConfigTxtData.emb4md15504cfg.rateSymbol3;


//______________________________________________________
for(unsigned i = 0; i < MODES_NUM; i ++)
{
configfilefext2[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].mode = // 1;// 
					  	   	 configfilefext1[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].mode;


configfilefext2[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].interf =	//2;//
						  	 configfilefext1[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].interf;



configfilefext2[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].rateEth0 =  //3;
						  	 configfilefext1[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].rateEth0;

configfilefext2[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].rateEth1 =  //4;
							 configfilefext1[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].rateEth1;

configfilefext2[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].rateEth2 =  	//5;
						  	 configfilefext1[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].rateEth2;

configfilefext2[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].rateEth3 =  	//6;
					   	  	 configfilefext1[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].rateEth3;


configfilefext2[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].extTypeRate0 =  //7;
			 	configfilefext1[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].extTypeRate0;

configfilefext2[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].extTypeRate1 = 
				configfilefext1[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].extTypeRate1;

configfilefext2[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].extTypeRate2 = 
				configfilefext1[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].extTypeRate2;

configfilefext2[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].extTypeRate3 = 
				configfilefext1[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].extTypeRate3;

   
configfilefext2[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].blockSize0 =  //0x11;
				  configfilefext1[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].blockSize0;

configfilefext2[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].blockSize1 =  //0x12;//
				  configfilefext1[variant].ConfigTxtData.emb4md15504cfg.mode15504[i].blockSize1;

}


#ifdef PRINT_PACK_CFG
for(i = 0; i < TXT_REAL_LEN_100; i ++)
{
if(!(i % 16)) printfpd("\n\r %04X>", i);
printfpd(" 0x%02X", configfilefext2[variant].ConfigTxtData.Data[i]);
}
#endif
}
...
#ifdef PRINT_PACK_CFG
	 printfpd("\n\r >>> length : %d", length);	  //543
#endif

//if(length > TXT_REAL_LEN)	 length = TXT_REAL_LEN;
//160618 if(length > TXT_REAL_LEN)	 length = 0l;   //120514

if(length > 600)	 length = 0l;   //160618

if(!length) return; //160618
...
// delay_mcs(10000l);//delay 10 ms
 ...
 if(length)  CopyStruct(variant);  //160618 for sat files only
...
for(unsigned long its = FULL_HEADER_SIZE + 4; its < (length + 4); its++)
{
 ...
 #define TEN_MHZ_KOEF (80000000l / 128l)
 #define REF_DISABLE_BIT (0x4)
 #define REF_OK_BIT	 (0x2)

extern "C" void SetTenMHz()
{
// printfp("\n\rSetTenMHz()");
 unsigned long output_code;
 static unsigned char  far_ten_mhz_status_keep;
 static unsigned char  ten_mhz_keep;
 static unsigned long  symbrate_keep;

   if(( far_ten_mhz_status_keep == 	far_ten_mhz_status) &&
		(ten_mhz_keep == ten_mhz) && (symbrate_keep == GetTSymbu()))
		{
		return;
		}
   ...
   outportb(TEN_MHZ_ADDRESS, ten_mhz);

   if(ten_mhz == INPUT_MODE)
   {
	  outportb(TEN_MHZ_RATE_ADDRESS, INPUT_CODE);
      outportb(TEN_MHZ_ADDRESS, ten_mhz);
   ...
   else	  //output mode
   {
	...
	if(!(far_ten_mhz_status & REF_OK_BIT))
	{
	   outportb(TEN_MHZ_ADDRESS, ten_mhz | REF_DISABLE_BIT);
	}
	else
	{
	    outportb(TEN_MHZ_ADDRESS, ten_mhz);
   	 ...
   	 output_code = 	(GetTSymbu() / (unsigned long)TEN_MHZ_KOEF) - 1l;

 //	 printfpd("\n\r output_code : 0x%X", output_code);
  //	  printfpd("\n\r GetTSymbu() : %d", GetTSymbu());

	 outportb(TEN_MHZ_RATE_ADDRESS, (unsigned char)output_code);
   }

far_ten_mhz_status_keep = 	far_ten_mhz_status;
ten_mhz_keep = ten_mhz;
symbrate_keep = GetTSymbu();
...
printfpd("\n\r%d FirmwareLoadm modem",time1); //1000118
...
if(!CheckEthMode(GetModEth() & 0xf)) 
{

SetEthMode(DEFAULT_MODE);

 #ifdef PRINT_ETH
	printfp("\n\r Setted Default Mode!");
#endif
...
//SetEthMode(GetModEth() & 0xf);	//121120
 #ifdef PRINT_ETH
	printfpd("\n\r GetModEth2 %02X" , GetModEth() );
#endif



SetEthMode(GetModEth() & 0x1f);	//160704
...
//ok return; //t
 ...
 //160617 moved to before ScanTxtFiles(); //comment do not get some
...
//#define   EmbMsgBuffer_Size (4)
//#else
//160713  #define   EmbMsgBuffer_Size (4)
 #define   EmbMsgBuffer_Size (10)
//#endif
...
//   printfpd("\n\r BufferAdd : %02X", Buff[Head].body[0]);
//   printfpd(" msg : %02X", msg.body[0]);
...
// #ifdef DEBUG_MAKET
//   printfpd("\n\r BufferGet1 : %02X", Buff[Tail-1].body[0]);
//#endif
...
// #ifdef DEBUG_MAKET
//   printfpd("\n\r BufferGet2 : %02X", Buff[BuffSize-1].body[0]);
//#endif
...
#define   EmbMsg485Buffer_Size (32)
...
///#endif
	   ...
	   //		printfpd("_%02X_", westByte);
			...
			case 0xAA: mode5AWest[i] = 0; recieveWest[i] = 1; ready_mod[i]=1; time3BlankMod[i] = time1; embMsgWest[i].Init();	break; 			
...
//
 ...
 // printEthLongHex(embMsgWest[i].AddrS()+ (embMsgWest[i].AddrI()<<16));
 ...
 //   printfp("\n\r_2");
							   //091111
  // 	  printEthLongHex(embMsgWest[i].AddrS());
...
//?? need check crc?
  ...
  printfpd("PLL Status : %02X\n\r",embMsgWest[i].Body(17));  //racm


#endif
  far_ten_mhz_status = 	embMsgWest[i].Body(17);
  SetTenMHz();

  unEmb2TypeVer.emb2TypeVer.signature_hardware[6] &=  ~((unsigned char) FAR_TEN_MHZ_MASK);
  unEmb2TypeVer.emb2TypeVer.signature_hardware[6] += (embMsgWest[i].Body(17) << 2) & FAR_TEN_MHZ_MASK ;
		...
		//	printfpd("i: %X ",embMsgWest[i].AddrI());
		 ...
		 //	 buff_cashe_tranzit.add(embMsgWest[i].body[1], embMsgWest[i].AddrS(), embMsgWest[i].AddrI(), embMsgWest[i].AddrR(), (unsigned long)embMsgWest[i].IsRS485());
				 ...
				 //____________________________________________________________
				   ...
				   tBuffEmbMsgEthAll.Add(embMsgWest[i]);	//160718
	   ...
	   switch(eastByte)
		{
				...
				case 0xAA: mode5AEast=0; countRecv++; recieveEast=1; ready_transit=1; time3BlankTransit = time1; embMsgEast.Init();//t InitEastE(); break; 			
				case 0xA5: mode5AEast = 0;	markerEast =1; ready_transit=1; time3BlankTransit /*= time3Marker*/ = time1;  break; // Маркеров здесь НЕТ!
...
//#ifndef DEBUG_ASU
//160729   printEthLongHex(embMsgA.FullSize());  //1E - sendstatus 0d - rnms
//#endif
	...
	//  printEthStringAdd(2,0);
  //hier send 	 printEthStringAdd(1,embMsgA.body[i]);	   
   //	  printEthStringAdd(2,0);
#endif
...
//		if(!recieveEast)
 ...
 //t printEthLongHex(embMsgA.AddrI());
	...
	//  printEthStringAdd(2,0);
   	// printEthStringAdd(1,embMsgA.body[i]);	   
   //	  printEthStringAdd(2,0);
#endif
...
unsigned long send_to_485_cnt;
unsigned long send_to_mod_cnt;
unsigned long rcv_from_485_cnt;
unsigned long rcv_from_mod_cnt;

EmbMsg embMsgA;

unsigned char ten_mhz;	  //bit 0 : 1/0on/off  bit 1 : 1/0  out/in
unsigned char set_eth;	
unsigned char far_ten_mhz_status;
unsigned char  far_ten_mhz_status_keep;
unsigned char  ten_mhz_keep;
unsigned long  symbrate_keep;

unsigned long eth_ans;
...
EthReceiveDelay = 0l;
  ...
  far_ten_mhz_status_keep = 0;
  ten_mhz_keep = 0;
  symbrate_keep = 0;


 ten_mhz = 0;
 far_ten_mhz_status = 0;
 set_eth = 0;
 send_to_485_cnt = 0;
 send_to_mod_cnt = 0;
 rcv_from_485_cnt = 0;
...
//160624   protection_mode = MODE_1_PLUS_1;
//  protection_mode = MODE_N_PLUS_1;
protection_mode = MODE_NO_PROT; //160624
...
//ok 120608 return;
 ...
 // time3Marker=0; 
  ...
  time1test=0;
   markerEast=0; ready_transit=0; dir=0; // 0 - "Transit->Mod", 1 - "Mod->Transit"
  old_ready_transit=0; // 0 - "Transit->Mod", 1 - "Mod->Transit"
  delete_msgWest=0; delete_msgEast=0;  recieveEast=0;
  HighID=0; countSend=0; countRecv=0;
  time3highID=0;
  mode5A=0; mode5AEast=0; 
...
//____________________________h i e r e n a b l i n g i  n t e r r u p t s  i n x i l i n x !!  
 ...
 //do not writed devidreturn;   //
//>>>>>>>>>>>>>>>>>>>>>>>>>>.do not write id!!!!!  return;
...
// this is error - not testted	frorousedtransit : will brocken buffer!	embSerialACT155.GetTransit();
	...
	unEmb2TypeVer.emb2TypeVer.type       = 0x0120;
...
//101008	unEmb2TypeVer.emb2TypeVer.signature_hardware[1] = read_xil_char(2);
	 ...
	 //		unEmb2TypeVer.emb2TypeVer.signature_hardware[6] = ten_mhz;
  unEmb2TypeVer.emb2TypeVer.signature_hardware[6] &=  ~((unsigned char) TEN_MHZ_MASK);
  unEmb2TypeVer.emb2TypeVer.signature_hardware[6] += ten_mhz & TEN_MHZ_MASK ;
...
//writed id setted loopireturn;

//hier writted id ereturn; 
...
modemp[0].SSC2(im);
 ...
 if(!MirrorTest())	return;	   //it is NOT hot restart - this maked to do not hangt without modem plata
...
unsigned char reset_reg = inportb(RESET_PORT);
printfpd("\n\r reset_reg : 0x%02X", reset_reg);
//delay_mcs(5000000l);
//reset_reg = inportb(RESET_PORT);
//printfpd("\n\r reset_reg after 5s : 0x%02X", reset_reg);
...
//printfp("1210046");
   ...
   CommonResetOff(im);
	  delay_mcs(1000000l);	//1s


reset_reg = inportb(RESET_PORT);

printfpd("\n\r reset_reg after reset off : 0x%02X", reset_reg);
...
//160704if((modemp[deviceindex].configfilefext.ConfigTxtData.emb4md15504cfg.numProvCode & MASK_BIT_1))
 if(1)
{
...
//110825  unStatePUM.statePUM.ulErrOut 					 	+=  modemp[deviceindex].protectionRxBytesFromProtection;
  ...
  */
  ...
  unStateBMD155p[mod].stateBMD155.count_no_correct_result =   modemp[deviceindex].fecUncorrectedBlockCounter;
  unStateBMD155.stateBMD155.count_no_correct_result =         modemp[deviceindex].fecUncorrectedBlockCounter;
//110825  unStatePUMp[mod].statePUM.ulErrOut 					 	+=  modemp[deviceindex].protectionRxBytesFromProtection;
//110825  unStatePUM.statePUM.ulErrOut 					 	+=  modemp[deviceindex].protectionRxBytesFromProtection;
  unStatePUMp[mod].statePUM.ulErrOut 				= modemp[deviceindex].fecUncorrectedBlockCounter;// Fc.rsErrorBytytounter;;
  unStatePUM.statePUM.ulErrOut 					 	= modemp[deviceindex].fecUncorrectedBlockCounter;// Fc.rsErrorBytytounter;;
// printfpd("\n\r  unStatePUM.statePUM.ulErrOut> %d", unStatePUM.statePUM.ulErrOut);
...
// printfpd("\n\r  unStatePUM.statePUM.ulBlock> %d", unStatePUM.statePUM.ulBlock);
...
//160704  unStatePUMp[mod].statePUM.ulErrAfterRS1 				  +=	 modemp[deviceindex].protectionUncorrectedBytes;
//160704  unStatePUM.statePUM.ulErrAfterRS1 				  +=	 modemp[deviceindex].protectionUncorrectedBytes;


			
//			Счётчик ошибок, исправленных РС в 1 стволе
  unStateBMD155p[mod].stateBMD155.count_no_correct_block1 	=  modemp[deviceindex].fecUncorrectedBlockCounter;	// modemp[deviceindex].protectionUncorrectedBytes;// Fc.rsErrorByteCounter;
  unStateBMD155.stateBMD155.count_no_correct_block1 	=	modemp[deviceindex].fecUncorrectedBlockCounter; //modemp[deviceindex].protectionUncorrectedBytes;// Fc.rsErrorByteCounter;
...
//160704   unStatePUMp[mod].statePUM.ulErrBeforeRS1 				  	+=   modemp[deviceindex].protectionUncorrectedBytes;
//160704  unStatePUM.statePUM.ulErrBeforeRS1 				  	+=   modemp[deviceindex].protectionUncorrectedBytes;
  unStatePUMp[mod].statePUM.ulErrBeforeRS1 				  	=    modemp[deviceindex].fecUncorrectedBlockCounter;
  unStatePUM.statePUM.ulErrBeforeRS1 				  	=    modemp[deviceindex].fecUncorrectedBlockCounter;
...
//  printfpd("\n\r Fc.fecUncorrectedBlockCounter> %d", Fc.fecUncorrectedBlockCounter);
...
//printEthLongHex(command_counter);
  ...
  ParseOperProg();
 #ifdef SEND_STATUS	//if set do not working eth_transit!!!!
   SendStatus();	  //160608
#endif
...
//do not writed id!!! return; //150224
...
// if(periodcnt > 300)
{
 ...
 #ifdef DEBUG_ETH_TRANZIT
//   printfpd("\n\r%d>> ", time1); 
 //   printfpd(" %d >? ", EthReceiveTimer); 
 //	  printfpd(" %d ",EthReceiveDelay); 
...
#ifdef ETH_DEBUG_485E
//   printfpd("\n\r%d>> ", time1); 
//printfpd(" TCPIP status: 0x%X",_task_get_status_from_name ("TCP/IP"));
//printfpd(" TCPIP error: 0x%X",_task_get_error_from_name ("TCP/IP"));
//embRS485.Trans_RDN(0x1111);	   //t
//RDN_receive("12345"); 
...
//	 printEthStringAdd(1,byte);	   
  ...
  // do NOT writed id!!!!!<<<<<<<<<<<<<<<<<<<<<<<<< return;
//return;
  unEmb2TypeVer.emb2TypeVer.signature_hardware[7] = (unsigned char)GetTempSat();


  periodcnt = 0;	 //  this get to hawe writted devid!!!
...
//#else
// ReadStateEasyD();  //110131  older bmdn4
//#endif
...
//t#ifndef WITHOUT_TRANZIT
	   	ProtocolFromTransitACT155();	//use unle for send modem  channel
//t#endif
...
//______________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________ flash :
 ...
 case 52: addr_status =     0x29; addr_data = 0x28; addr_type =  0x2A;  addr_send =   0x2B; type_channel = 0x2F;   break; //termometr
 case 53: addr_status =     0x29; addr_data = 0x28; addr_type =  0x2A;  addr_send =   0x2B; type_channel = 0xB;    break; //mem xil
...
#define TEN_MHZ_PORT   (0x7D)
#define  TMODE_PORT	   (0x7C)
#define  TEMPERATURE_PORT	   (0x7B)


void WritePort()
{
// printfpd("\n\r WritePort() Body(0) 0x%2X ",embMsgRequest->Body(0));
// printfpd("\n\r WritePort() Body(1) 0x%2X ",embMsgRequest->Body(1));
//printfpd("\n\r WritePort()  Body(2) 0x%2X ",embMsgRequest->Body(2));
//printfpd("\n\r WritePort() Body(3) 0x%2X ",embMsgRequest->Body(3));
//printfpd("\n\r WritePort()  Body(4) 0x%2X ",embMsgRequest->Body(4));
   ...
   //		embMsg485Request_1.SetReadyToSend();
	...
	else
	{
		...
		//	embMsg485Request_2.SetReadyToSend();
		 ...
		 else if(((embMsgRequest->Body(0))== TEN_MHZ_PORT) && (!(embMsgRequest->Body(1))))
	{
 ...
 //			unEmb2TypeVer.emb2TypeVer.signature_hardware[6] = ten_mhz;
  ...
  unEmb2TypeVer.emb2TypeVer.signature_hardware[6] += ten_mhz & TEN_MHZ_MASK ;
	 ...
	 else if(((embMsgRequest->Body(0))== TMODE_PORT) && (!(embMsgRequest->Body(1))))
	{
		  //	if(CheckEthMode(embMsgRequest->Body(0) & 0xf)) 
		  //	{
		 //   SetModEth(embMsgRequest->Body(0));
		   ...
		   //	 printfpd("\n\r WritePort() 0x%2X ");
		    		 ...
		    		 if(embMsgRequest->Body(4) <= MAX_MTMODE)
					 {
		  			SetMTModeSNMP(embMsgRequest->Body(4));
					 }
	   ...
	   else if(((embMsgRequest->Body(0))== TEMPERATURE_PORT) && (!(embMsgRequest->Body(1))))
	{
			...
			embMsgAns.SetBody(2,0);
			embMsgAns.SetBody(3,0);
			embMsgAns.SetBody(4, GetTempSat());
			embMsgAns.SetLength(5);
		//	}
...
//160711StatusMsg.SetLength(17); //160310 add ratimestep
StatusMsg.SetLength(18); //160711 add 10MHz statu
...
#endif
StatusMsg.SetBody(17, inportb(TEN_MHZ_STATUS));
...
//  extern "C" unsigned char ModemMailboxMessageSend(unsigned short msgLen, unsigned char * pData)
 ...
 tBuffEmbMsgEast.Add(StatusMsg);	  //  whu ??????? need send! is not need parse this! do not have
...
//#endif
			 ...
			 //	 printfpd(" %X", embMsgA.AddrR());	//t
				 printfpd(" %X", embMsgA.AddrS());	//t
...
//#ifndef USE_SOCKETSD
			   ...
			   //		 for(long isend = 0; isend < 100; isend++) //test090708
				   //		 SendAnsTransitToEth();
						 SendAnsTransitToEthU(GetIPRemUDP() & 0xFFFF);

#else
					buff_udpt[l_udpt_inc()] =	0x55;
					buff_udpt[l_udpt_inc()] =	0xAA;
					for(i=0; i<embMsgA.FullSize(); i++) 
						{
				 			switch(embMsgA.body[i])
							{
								case 0x5A:   buff_udpt[l_udpt_inc()] = 0x5A; buff_udpt[l_udpt_inc()] = 0x00; break;
								case 0x55:  buff_udpt[l_udpt_inc()] =	0x5A;  buff_udpt[l_udpt_inc()] = 0x01; break;
								case 0xA5: buff_udpt[l_udpt_inc()] =	0x5A; buff_udpt[l_udpt_inc()] = 0x02; break;
								case 0xAA: buff_udpt[l_udpt_inc()] =	0x5A; buff_udpt[l_udpt_inc()] = 0x03; break;
								default: buff_udpt[l_udpt_inc()] = embMsgA.body[i]; 
							}
						}

						 buff_udpt[l_udpt_inc()] = 0x55;
						 flag_send_udp_asu = 1; //can send it
...
//			if(++ic>16) return;
	   ...
	   //		AddCharWestE(westByte);
   	   ...
   	   printfpd(" %02X",ethByte );
			...
			case 0xAA: recieveWestE = 1;   embMsgEthTransitW.Init(); mode5AWestE=0;  break;  //mode5AWestE=0; !!!!!!			
...
#ifdef DEBUG_ETH_TRANZIT
   	printfp("\n\r... IsEnd()");
 //	printfpd( "body[0] : %02X " ,embMsgEthTransitW.body[0]);
 //	printfpd( "body[1] : %02X \n\r" ,embMsgEthTransitW.body[1]);


#endif
		  if(!(embMsgEthTransitW.ChkCRC()))
		  	  {
		  	 //  printEthLongHex(0);
...
//090515				if(embMsgEthTransitW.AddrS()==SelfID())
			...
			if(1)	  //t 090427
				...
				{
#ifdef DEBUG_MAKET
//ok		 printfpd("\n\r add to buffer : 0x%04X", embMsgEthTransitW.AddrS());
#endif
   eth_req++;
...
extern "C" void LoadFiltersO (unsigned char baud, unsigned char chnl)
{
...
if(!chnl)
{
WriteReadSpiBm( 50,  length_of_data, BufferData, BufferData);
}
else
{
WriteReadSpiBm( 51,  length_of_data, BufferData , BufferData);
