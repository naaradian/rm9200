...
//________________________________________________________________________bmdn1
               ...
               case 0x50: // 
                ...
                //    printEthLongHex(modemp[0].configfilefext.LengthTxt);
                    if(modemp[0].configfilefext.LengthTxt !=  TXT_CUR_REAL_LEN)
                    { 
...
//                     for(i=0; i < modemp[0].configfilefext.LengthTxt; i++)
                      for(i=0; i < 104; i++)
                      {
                       embMsgAns.SetBody((i+1), modemp[0].configfilefext1[embMsgRequest->Body(0)].ConfigTxtData.Data[i]);
                      }
                    }   
                  }
              ...
              case 0x52: // 
                  ...
                  embMsgAns.SetLength(8);
                   for(i=0; i < 8; i++)
                      {
                       embMsgAns.SetBody(i,modemp[0].txAcmProfilesCounter[i]);
                      }
                    break;
...
//________________________________________________________________________bmdn1                        
                   ...
                   case 0x65: //  ModemAcmProfileMaskGet
