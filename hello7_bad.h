...
//#define PROG_BMDN6	 //try md310e.cpp+ filters act155051 1+0 use PVG710 maked mode 1+1  bmdn6.cpp!!!+ pvg610_api.c	hostdriverforpc.cpp   utils.c endian.c
...
//#define PROG_ACT155N		//nazemnaja - 10 ms fast 485 packets	//need recompile mib
...
//#define PROG_PU_M100	 //pu_m100.cpp	 
//#define PROG_PU_MSAT	 // linkdoubler 1024 tfs_data.c web interface  file need copy!!!! pu_msat.cpp  1024
...
//#define	 PROG_PRM_PCH_SPI_NOXIL_ETH  // prm_pch_spi_noxil_eth.cpp spi+ eth
...
#define SOFT_VER_STRING      "      15.02.17.1-845    "//263 : maked init counter and data for write_buffer_char1()
//#define SOFT_VER_STRING      "   15.01.30.1-833 ADESTO"//263 : maked init counter and data for write_buffer_char1()
//#else
//#define SOFT_VER_STRING   "Radian v.831.50127       "
//#endif

//#else
//#define SOFT_VER_STRING      "   15.01.27.1-831 ADESTO"//263 : maked init counter and data for write_buffer_char1()
//#endif

#else
//#define SOFT_VER_STRING "Radian Ver. 01.00        "//263 : maked init counter and data for write_buffer_char1()
#define SOFT_VER_STRING   "Radian v.845.50210       "//263 : maked init counter and data for write_buffer_char1()
#endif
//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>

//#define HTTP_PRINTM

//#define PR_FL	 //debug print
//#define REAL_PROBE
...
//#define D485_REQUEST_DELAY	 (51)
#define D485_REQUEST_DELAY	 (31)
...
#define STATE_REGISTER (0xE3)		// регистр состояния каналов Е1
#define SOUND_STATE_REGISTER (0xF4)
#define XILINX_ALARM_REGISTER (0xF6)  // регистр реле аварийной сигнализации
#define Tx34           0x03		  // регистр состояния DTVM
...
void save_e14_reg(int , int , int , unsigned , unsigned char );
int SetBusy8k(int , unsigned char *);
int FindFree8k(int , unsigned char *);ree8k(int , unsigned char *);int , int , int , unsigned );
extern "C" void ReadDPD(char * );
extern "C" void InitFreePtr(void);
extern "C" void ToIBuf(unsigned char data);
extern "C" void PultDelay(void);
...
#define	 MAX_SATSET8	(1000)   define	 MAX_SATSET8	(1000)   SATDF	(0)
#define	 MAX_SATDF	(12)
...
//#define IN   0x30000000

//#define INo	 //i enable no more 200000 interrupts irq 0 in 1 ms - not many?
//#define INTERRUPT_WAIT (200000)	 //i enable no more 200000 interrupts irq 0 in 1 ms - not many?
...
//#define POWER_ALARM		(85 << 1)
#define POWER_ALARM		(87 << 1)  //161223 2 W
...
#define CHAN_LOCK_BIT (0x2)
#define CHAN "C" void InitSetConfigFile(unsigned char);
...
extern "C" void SetParamsFromCfg1(unsigned char);
...
#define LED_FA		(0xB)
#define BIT_REMOTE  // включен режим удаленного управления
#define BIT_TESTMOD // включен тестовый режим
#define BIT_STOR_AL // зафиксированы аварии  
...
#define MIN_MOUTLEV	  (float64)5/ine MIN_MOUTLEV	  (float64)5/	  (float64)30//(-5.0)
...
#define MIN_MKIN1	  (float64)-99//1//(-30.0)
#define MAX_MKIN1	  (float64)99//999//(-5.0)

#define MIN_MKIN2	  (float64)1//(-30.0)
#define MAX_MKIN2	  (float64)999//(-5.0)

#define MIN_MKIN3	  (float64)1//(-30.0)
#define MAX_MKIN3	  (float64)999//(-5.0)
...
terf,  unsigned char phyId,
nsigned char changephy );
...
//#define LOAD_ONE_PROVINGENT_ON_PLATA  //for specific use only
...
//#define MAX_NUM_CFG	 (50)	 /// MAX не более 16 cfg иначе не линкуется
#define MAX_NUM_CFG	  (100)

//#define MAX_CFG_FILE_VARIANT (256)	//максимум	256 конфигураций
//#define MAX_CFG_FILE_VARIANT (115)	//максимум	115 для 4 MB
#define MAX_CFG_FILE_VARIANT (MAX_NUM_CFG)	//максимум	115 для 4 MB
...
//#define IncEmbSerialMD34AVT
//#define XilSizeToDownloadD    (48)   // to can Spartan3 500
//#define XilSizeToDownloadD    (200000XilSizeToDownloadD    (200000/t #define XilSizeToDownloadD    (175000)   // to can Spartan3 2500
//#define XilSizeToDownloadD    (169217)   // t   to can Spartan3 2500
#define XilSizeToDownloadD    (740000)   // t  have BIT files for all xilinxes
#define XilSizeToDownloadD2   (285000)   // to can Spartan3 500
#define XilSizeToDownloadD3   (285000)  
...
#define ID_ADDRESS3  (0xC01FC000)	//for keep freq
...
//110111#define DEV_ID_SIZE	(290) //PRdefine DEV_ID_SIZE	(290) //PRIZE	   	   (362) //BMDN2 + (18 * 4)	protection
...
extern "C" voidnd6(char *);
extern "C" voidern "C" void  ParseCommand8(char *);
...
#ifndef PROG_PRM_PCH_SPI
//#define RUN_TIME  (7)
#define RUN_TIME  		(30) //this was before all
...
extern void OperateBuffers_usart1(void);
...
#define SSC1_SEND_SIZE  (5)
#define SSC1_SEND_SIZE  (5)efine SSC1_RECEIVE_SIZE 5 //8 //70 // (5)
...
#define MAX_SYMBOL_RATE	  (5)  //101117
