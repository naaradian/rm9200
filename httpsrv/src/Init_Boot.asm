...
;;t    .sect ".Flash"   ; Flash API checks this for
;; t   .word 0xFFFE     ; silicon compatability
    
;; t   .sect ".Version"
;; t   .word 0x0003     ; 280x Boot ROM Version 3
;; t  .word 0x0405     ; Month/Year: (4/05 = April 2005)
    
;; t   .sect ".Checksum"; 64-bit Checksum
;; t   .long 0x6A78A069 ; least significant 32-bits
;; t   .long 0x000003B5 ; most significant 32-bits
