...
extern unsigned long DelayWriteTime;
#endif
...
outportb(STATUS_610_ADDR,0x1);	//


 return;   //in dmu one provingent!!!____________________________________________________________


variant1 =  GetNumConfigFile(1) & CONFIG_FILE_MASK;	//self number is hier for second provingent 
#ifdef START_PRINT
...
//160523   protection_mode = MODE_1_PLUS_1;
//  protection_mode = MODE_N_PLUS_1;
...
unsigned long   variant =  GetNumConfigFile(0) & CONFIG_FILE_MASK;
unsigned long   variant1 =  GetNumConfigFile(1) & CONFIG_FILE_MASK;	
...
// printfpd("\n\rscsn errors: %d", curmod);
  ...
  switch(curmod)
  {
	...
	case 1 :     ReadErrors2(0);  /*ReadErrors3(0);*/ /* ReadErrors1(curmod); */curmod++; break;
...
//______________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________ flash :
 ...
 case 48: addr_status =     0x29; addr_data = 0x28; addr_type =  0x2A;  addr_send =   0x2B; type_channel = 0x0C;   break; //hier is IF plata  for md100se
...
extern "C" void LoadTraffic(unsigned char framecon,
							unsigned char enf0_7,
							unsigned char enf8_15,
							unsigned char enf16_21,
							unsigned char enf_stm,
							unsigned char enf_eth,
							unsigned char enf_tb,
							unsigned char enf_test,
							unsigned char chnl)
{
...
// SetSelector(chnl);
  ...
  if (blocktype == PROV_TYPE)	 //for xcs2 type only
 {
//  outportb(GAIN_PORT, gain);
 //}

outportb( FRAMECON_PORT, framecon);
outportb( ENF0_7_PORT, enf0_7);
outportb( ENF8_15_PORT, enf8_15);
outportb( ENF16_21_PORT, enf16_21);
outportb( ENF_STM_PORT ,enf_stm);
outportb( ENF_ETH_PORT, enf_eth);
outportb( ENF_TB_PORT,enf_tb);
outportb( ENF_TEST_PORT ,enf_test);
