...
// 0x80 = 2,6 — 17,7ÃÃö (L - äèàïàçîíà)
// 0x81 = 17,7 - 26,5ÃÃö (L - äèàïàçîíà)
// 0x82 = 26,5 - 40,0ÃÃö (L - äèàïàçîíà)
// 0x83 = 40,0 – 60,0ÃÃö (L - äèàïàçîíà)
// 0xC0 = 23,3 - 29,4ÃÃö (L - äèàïàçîíà)
// 0xC1 = 38,0 - 49,1ÃÃö (L - äèàïàçîíà)
...
//	double temp_dbl;
	if(band==0x80) // 0x80 = 2,6 — 17,7ÃÃö (L - äèàïàçîíà)
	{
//		if(ver==5)
	  {
...
//			f_tm = f_in - 568000;//550000;
	...
	if(band==0x82) // 0x82 = 26,5 - 40,0ÃÃö (L - äèàïàçîíà)
	{
	  {
...
//			if((f_in>=2433000)&&(f_in<2650000)) b[1]=0x08;
			...
			if(f_in<=3250000) ///&&(f_in!=2800000)&&(f_in!=3200000))  22/05/15
			{
				f_tm = f_in + 1445000;
				b[2] = 0x04; // Commut K
	...
	if(band==0x81) // 0x81 = 17,7 - 26,5ÃÃö (L - äèàïàçîíà)
	{
	  {
...
//			if((f_in>=2433000)&&(f_in<2650000)) b[1]=0x08;
	...
	if(band==0x83) // 0x83 = 40,0 – 60,0ÃÃö (L - äèàïàçîíà)
	{
	  {
...
//			if((f_in>=2433000)&&(f_in<2650000)) b[1]=0x08;
	...
	if(band==0xC0) // 0xC0 = 23,3 - 29,4ÃÃö (L - äèàïàçîíà)
	{
	  {
...
//			if((f_in>=2433000)&&(f_in<2650000)) b[1]=0x08;
	...
	if(band==0xC1) // 0xC1 = 38,0 - 49,1ÃÃö (L - äèàïàçîíà)
	{
	  {
