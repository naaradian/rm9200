...
extern "C" void ParseUD_1()
{
 ...
 switch(embMsgUD_1.Body(0))
 {
  ...
  pupm1.embpupm2.verp   =   unEmb2TypeVer.emb2TypeVer.signature_hardware[0];
...
switch(addr)
{
 case 0x00:  pupm1.byte[0] = data;	SetFreqPUPM2(1); break;
 case 0x01:  pupm1.byte[1] = data;	SetFreqPUPM2(1); break;
 case 0x02:  pupm1.byte[2] = data;	SetFreqPUPM2(1);  break;
 case 0x03:  pupm1.byte[3] = data;	SetFreqPUPM2(1);  break;
 case 0x04:  pupm1.byte[4] = data;	SetAttPUPM2(1);	  break;
 case 0x10:  pupm2.byte[0] = data;	SetFreqPUPM2(4);  break;
 case 0x11:  pupm2.byte[1] = data;	SetFreqPUPM2(4);  break;
 case 0x12:  pupm2.byte[2] = data;	SetFreqPUPM2(4);  break;
 case 0x13:  pupm2.byte[3] = data;	SetFreqPUPM2(4);  break;
 case 0x14:  pupm2.byte[4] = data;	SetAttPUPM2(4);	  break;
 default :  return 0;
}
...
switch(addr)
{
 case 0x00:  *data = pupm1.byte[0];   GetCode1();	 break;
 case 0x01:  *data = pupm1.byte[1];   GetCode1();	 break;
 case 0x02:  *data = pupm1.byte[2];   GetCode1();	 break;
 case 0x03:  *data = pupm1.byte[3];   GetCode1();	 break;
 case 0x04:  *data = pupm1.byte[4];   GetCode1();	 break;
 case 0x05:  *data = pupm1.byte[5];   GetCode1();	 break;
 case 0x06:  *data = pupm1.byte[6];   GetCode1();	 break;
 case 0x07:  *data = pupm1.byte[7];   GetCode1();	 break;
 case 0x08:  *data = pupm1.byte[8];   GetCode1();	 break;
 case 0x10:  *data = pupm2.byte[0];   GetCode4();	 break;
 case 0x11:  *data = pupm2.byte[1];   GetCode4();	 break;
 case 0x12:  *data = pupm2.byte[2];   GetCode4();	 break;
 case 0x13:  *data = pupm2.byte[3];   GetCode4();	 break;
 case 0x14:  *data = pupm2.byte[4];   GetCode4();	 break;
 case 0x15:  *data = pupm2.byte[5];   GetCode4();	 break;
 case 0x16:  *data = pupm2.byte[6];   GetCode4();	 break;
 case 0x17:  *data = pupm2.byte[7];   GetCode4();	 break;
 case 0x18:  *data = pupm2.byte[8];   GetCode4();	 break;
...
// for(unsigned char addr = current_command_data[0]; addr <= current_command_data[0] + ; addr++)
  {
    if(!RunReading(addr, &BufferAnswer[anslen1])) ret = 0;
 ...
 switch(embMsgUD_4.Body(0))
 {
  case 0: if(start4)
   {unEmb2TypeVer.emb2TypeVer.signature_hardware[1] = embMsgUD_4.Body(1) &  PUPM2_TYPE_CONV_MASK; 
	 pupm2.embpupm2.verp   =   unEmb2TypeVer.emb2TypeVer.signature_hardware[1];
...
if(current_command_type != 2)
 {
  ...
  { 
   ...
   //	  if((current_command_type == 1)	|| (Havefirstaddr && Havetwoaddr))
	  if((current_command_type == 1)	|| (Havefirstaddr))
	  {
 ...
 //		 current_command_data[current_command_data_counter++] = rch; //for command type 1
   ...
   printfpd("(twoaddr:%X)", rch);
		 ...
		 {
		    if(current_command_type == 2)    CommandDataLength[current_command_type] = (rch - firstaddr)nd_type] = (rch - firstaddr)nst		    if(current_command_type == 3)    CommandDataLength[current_command_type] = (rch - firstaddr) + 6;
...
//unsigned char Data[] = {0xFE,0xFE,0x44,02,0,01,02,00,0x49,0xFC,0xFC};	vol = 11; //command 44  3 byte
...
case  1 : 
 ...
 countMod = 0;
	       delaycountMod = 0;
	       delay5CommandRecieverSetFrequ1.emb5commandrecieversetfrequ.frequ =  (pupm1.embpupm2.freq3 << 24) + (pupm1.embpupm2.freq2 << 16) +  (pupm1.embpupm2.freq1 << 8)  + pupm1.embpupm2.freq0; 
		   KeepParam(emb5CommandRecieverSetFrequ1.emb5commandrecieversetfrequ.frequ , FREQ1_ADDR);
		   emb5StatusReciever1.emb5statusreciever.frequ = emb5CommandRecieverSetFrequ1.emb5commandrecieversetfrequ.frequ;
		   SetFreq1();
			// Stephany19++;
...
case  1 : 
		   ...
		   countMod = 0;
	       delay1 = NO_SCAN_DELAY;
		   emb5CommandRecieverSetAtt1.emb5commandrecieversetatt.stepAtt = pupm1.embpupm2.att; 
   	//091025 	   emb5StatusReciever1.emb5statusreciever.stepAtt =  emb5CommandRecieverSetAtt1.emb5commandrecieversetatt.stepAtt;   
		   KeepParam(emb5CommandRecieverSetAtt1.emb5commandrecieversetatt.stepAtt , ATT1_ADDR);
		   SetAtt1();
#ifdef	   PROG_PRM_PCH_L
...
case  4 : 
			...
			countTransit4 = 0;
		    delay4 = NO_SCAN_DELAY;
			emb5CommandRecieverSetAtt4.emb5commandrecieversetatt.stepAtt = pupm2.embpupm2.att; 
   //			emb5StatusReciever4.emb5statusreciever.stepAtt =  emb5CommandRecieverSetAtt4.emb5commandrecieversetatt.stepAtt;   
   			KeepParam(emb5CommandRecieverSetAtt4.emb5commandrecieversetatt.stepAtt , ATT4_ADDR);		  
		    SetAtt4();
#ifdef	   PROG_PRM_PCH_L
