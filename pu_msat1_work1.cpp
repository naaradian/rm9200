...
//150128 SatGet2.Value = SatSet1.Value + DD +  ((float64)((RGsat * 4) + 1.5) /  (float64)128 ) * 1.31;
 SatGet2.Value = SatSet1.Value +  ((float64)((RGsat * 4) + 1.5) /  (float64)128 ) * 1.31;
...
// MaxSatSet1 = ((float64)MIN_SATSET1 + ((float64)(RGdd + 1)  * (float64)0.2048))*((float64)100000000 / (float64)F_SYSTEM);
 ...
 DelMin = SatSet1.Value - MinSatSet1;
 DelMax = MaxSatSet1 - SatSet1.Value;
 if(DelMin < DelMax)
 {
