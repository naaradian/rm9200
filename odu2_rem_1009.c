...
printfpd("\n\r  send_to_485_cnt: %d", send_to_485_cnt);             
#endif           
...
//#endif
      ...
      rcv_from_mod_cnt++; 
#ifdef ETH_DEBUG_485E
printfpd("\n\r  rcv_from_mod_cnt: %d", rcv_from_mod_cnt);             
#endif          
...
//} //t100524
  ...
  //eth_transit is need only for modem channel!!!!                   tBuffEmbMsgEthAll.Add(embMsg232);
    	...
    	if(flagRequest == 2)     //from modem channel    160627
  		{
	                //  tBuffEmbMsgEast.Add(embMsgAns);
...
#ifdef ETH_DEBUG_485E
printfpd("\n\r  rcv_from_485_cnt: %d", rcv_from_485_cnt);             
#endif                   
...
#ifdef ETH_DEBUG_485E
printfpd("\n\r  send_to_mod_cnt: %d", send_to_mod_cnt);             
#endif         
  ...
  //============================================================================================		
    ...
    //        printEthLongHex(5);
	       ...
	       txtransb++;
			 printfpd(" t: %d \n\r", txtransb);
#endif
				 		tBuffEmbMsgEast.Add(embMsgRequest);     //send to modem channel
