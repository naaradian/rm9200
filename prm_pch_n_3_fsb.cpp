...
unsigned char * Formula3fsb(unsigned short f_in, unsigned char a_filtrPCh)
{
...
////////////////////////////////////
	if((f_in>=20)&&(f_in<=3000))
	{
		...
		{
			f_tm = f_in + 1840;  // новомар 01/03/11 1850 
														// фсб 01/03/11 1840 
		...
		{
			f_tm = f_in + 540; // новомар 01/03/11 550
														// фсб 01/03/11 540 
			double Ftemp = f_tm * 1000000.0;
			Fsint = (f_tm * 1000000.0);
			A = Fsint/Fdds0/2; 
...
//if((f_in>=150)&&(f_in<260)) ucFiltrVCh=0x1C;	
		...
		if((f_in>=960)&&(f_in<1140)) ucFiltrVCh=0xE5; //0x23;		
...
unsigned char * b = Formula3fsb(emb5CommandRecieverSetFrequ1.emb5commandrecieversetfrequ.frequ ,Filtr);
//					Formula3nov
			   /* prm_pch_N_1!!!!
