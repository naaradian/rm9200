...
//___________________________________----for test hanging

//WriteDevId(); //for test hanging

//cnt /= flag;  //divide to zero
...
// #define LONG_ETH_TIME	(3)	  //ok
#define LONG_ETH_TIME	(6)
...
{
 cntt1 = 0;
printfpd("\n\rf: %d", GetFreqN());   //rate 115200
printfpd("a %d ", GetAttN());   //rate 115200
printfpd("a2 %d ", GetAtt2N());
printfpd("a3 %d ", GetAtt3N());
printfpd("a4 %d ", GetAtt4N());
...
{
//130531 outportb(ALARMOP_SPI_XIL,0);
}

extern "C" void SetLineAlarmToOneX()
{
//130531  outportb(ALARMOP_SPI_XIL,1);
}
...
//#else
 ...
 //do not get somthing  LoadDDSN2();	  //140422
 //programm restart do not enable signal
...
//printfpd2(" % d", att3_reg);
//04piob_ptr->CODR = maskb;
outportb(ATT4_SPI_XIL,att4_reg);
...
//char cntbuff = 0;
  ...
  return; //________________140603 servicepack get off
