...
//                     embMsgAns.SetBody(0, embMsgRequest->Body(0));
       ...
       case 0x71: // Запрос состояния1
			   //		printEthLongHex(0x50);
			   	  //		ReadPum100();

							embMsgAns.SetType(0x71);
							embMsgAns.SetLength(LEN_MD100SE);
							for(i=0; i<LEN_MD100SE; i++) embMsgAns.SetBody(i,dev1.byte[i]);
						break;
