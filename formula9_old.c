...
// Версия от 30/09/2010 добавлено перекрытие по 4-му ПРм band==3
 ...
 //	static unsigned char b[16];
 	static unsigned char b[24]; //+get1 +get2
...
//	double temp_dbl;
	...
	if((f_in<1770000))
	{
		if((ver==6)||(ver==7))
	  {
			...
			if((f_in>=1030000)&&(f_in<1120000)) att=9;
			if((f_in>=1120000)&&(f_in<1210000)) att=8;
			if((f_in>=1210000)&&(f_in<1280000)) att=6;
			if((f_in>=1280000)&&(f_in<1300000)) att=7;
			if((f_in>=1300000)&&(f_in<1340000)) att=8;
			if((f_in>=1340000)&&(f_in<1390000)) att=7;
			if((f_in>=1390000)&&(f_in<1490000)) att=5;
			if((f_in>=1490000)&&(f_in<1640000)) att=3;
			if((f_in>=1640000)&&(f_in<1660000)) att=1;
			if((f_in>=1660000)&&(f_in<1700000)) att=0;
			if((f_in>=1700000)&&(f_in<1770000)) att=0;	  
            ...
            *get1 =  692000;
				double Ftemp = f_tm * 10000.0;
				b[2] = 0x02; // Commut K
				if((f_in>=1517500)&&(f_in<1522500))
				{
					b[2] = 0x42; // Commut K		
					f_tm = f_in + 682000;
               *get1 =  682000;
				}
				if((f_in>=1311000)&&(f_in<1131300))
				{
					b[2] = 0x42; // Commut K		
					f_tm = f_in + 682000;
               *get1 =   682000;
	...
	if((f_in>=2650000)&&(f_in<40100000))
	{
		if((ver==5)||(ver==6)||(ver==7))
		{
	   	...
	   	if((f_in>=3160000)&&(f_in<3310000)) att=15;	
			...
			if((f_in>=3460000)&&(f_in<3500000)) att=13;
			...
			if((f_in>=3800000)&&(f_in<3840000)) att=5;
...
//			double Fdds0 = 190000000.0; // переопределение переменной для 4 версии 
			unsigned char att= 0x00;
/*
			if((f_in>=4000000)&&(f_in<4100000)) att=10;
			if((f_in>=4100000)&&(f_in<4180000)) att=9;
			if((f_in>=4180000)&&(f_in<4220000)) att=10;
			if((f_in>=4220000)&&(f_in<4510000)) att=13;
			if((f_in>=4510000)&&(f_in<4540000)) att=10;
			if((f_in>=4540000)&&(f_in<4570000)) att=8;	 
			if((f_in>=4570000)&&(f_in<4620000)) att=6;	
			if((f_in>=4620000)&&(f_in<4650000)) att=8;	
			if((f_in>=4650000)&&(f_in<4710000)) att=10;	
			if((f_in>=4710000)&&(f_in<4730000)) att=8;	
			if((f_in>=4730000)&&(f_in<4770000)) att=6;	
			if((f_in>=4770000)&&(f_in<4780000)) att=3;	
			if((f_in>=4840000)&&(f_in<4890000)) att=3;	
			if((f_in>=4890000)&&(f_in<4900000)) att=6;	
			if((f_in>=4900000)&&(f_in<4960000)) att=9;	
			if((f_in>=4960000)&&(f_in<5090000)) att=5;	
			if((f_in>=5090000)&&(f_in<5160000)) att=7;	
			if((f_in>=5160000)&&(f_in<5200000)) att=3;	
			if((f_in>=5360000)&&(f_in<5370000)) att=5;	
			if((f_in>=5370000)&&(f_in<5460000)) att=7;	
			if((f_in>=5460000)&&(f_in<5490000)) att=3;	
			if((f_in>=5590000)&&(f_in<5640000)) att=3;	
			if((f_in>=5810000)&&(f_in<5910000)) att=3;	
			 */
          
		   if((f_in>=4000000)&&(f_in<4100000)) att=8;
			if((f_in>=4100000)&&(f_in<4180000)) att=7;
			if((f_in>=4180000)&&(f_in<4220000)) att=8;
			if((f_in>=4220000)&&(f_in<4510000)) att=11;
			if((f_in>=4510000)&&(f_in<4540000)) att=8;
			if((f_in>=4540000)&&(f_in<4570000)) att=6;	 
			if((f_in>=4570000)&&(f_in<4620000)) att=4;	
			if((f_in>=4620000)&&(f_in<4650000)) att=6;	
			if((f_in>=4650000)&&(f_in<4710000)) att=8;	
			if((f_in>=4710000)&&(f_in<4730000)) att=6;	
			if((f_in>=4730000)&&(f_in<4770000)) att=4;	
			if((f_in>=4770000)&&(f_in<4780000)) att=1;	
			if((f_in>=4840000)&&(f_in<4890000)) att=1;	
			if((f_in>=4890000)&&(f_in<4900000)) att=4;	
			if((f_in>=4900000)&&(f_in<4960000)) att=7;	
			if((f_in>=4960000)&&(f_in<5090000)) att=3;	
			if((f_in>=5090000)&&(f_in<5160000)) att=5;	
			if((f_in>=5160000)&&(f_in<5200000)) att=1;	
			if((f_in>=5360000)&&(f_in<5370000)) att=3;	
			if((f_in>=5370000)&&(f_in<5460000)) att=5;	
			if((f_in>=5460000)&&(f_in<5490000)) att=1;	
			if((f_in>=5590000)&&(f_in<5640000)) att=1;	
			if((f_in>=5810000)&&(f_in<5910000)) att=1;	
...
//			double Fdds0 = 190000000.0; // переопределение переменной для 4 версии 
			...
			if((f_in>=4310000)&&(f_in<4370000)) att=5;
			if((f_in>=4570000)&&(f_in<4640000)) att=5;
			if((f_in>=4640000)&&(f_in<4780000)) att=9;
			if((f_in>=4780000)&&(f_in<4960000)) att=7;
			if((f_in>=4960000)&&(f_in<5110000)) att=10;
			if((f_in>=5110000)&&(f_in<5280000)) att=11;	 
			if((f_in>=5280000)&&(f_in<5570000)) att=13;	
			if((f_in>=5570000)&&(f_in<5640000)) att=10;	
			if((f_in>=5640000)&&(f_in<5710000)) att=8;	
