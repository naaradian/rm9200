...
hello7.elf:  hello7.o asm_test.o work.o spi_pol.o at45.o work1.o jump.o EMBISR.o ttl.o hello.o dataflash.o commutator2.o rtcs.a atevbrm9200.a mqx.a libc.a met.o
	@echo Linking...  
...
-include C:\ARC\mqx2.50_atevbrm9200.met\examples\hello7\commutator2.d

commutator2.o:
	@echo Compiling C:\\ARC\\mqx2.50_atevbrm9200.met\\examples\\hello7\\commutator2.cpp ...  
	@$(CC) -Hnocopyr -c -Hasopt=-c @C:\ARC\mqx2.50_atevbrm9200.met\examples\hello7\hello7.opc C:\ARC\mqx2.50_atevbrm9200.met\examples\hello7\commutator2.cpp
