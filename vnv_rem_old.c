...
#include stack_commands_vnv.c       //232
...
//____________________________________________________________________________________RDN  <<
			...
			//			printf("\n\r     embMsgRequest->Type:%d ",embMsgRequest->Type());
#include stack_commands_vnv.c         //east
...
//____________________________________________________________________________________RDN  <<
			...
			//			printf("\n\r     embMsgRequest->Type:%d ",embMsgRequest->Type());
#include stack_commands_vnv.c   //west
...
if(IsEthTransitMode())
{
	   ...
	   //		printf("\n\r> %04X ", embMsgRequest->AddrS());
			...
			//			printf("\n\r     embMsgRequest->Type:%d ",embMsgRequest->Type());
#include stack_commands_vnv.c     //rBuffEmbMsgE
...
//<<<<<<<<<<<<<<<<<<   hier stack commands
#include stack_commands_vnv.c   //485
...
//____________________________________________________________________________________RDN  <<
      ...
      //    #endif
			...
			//			printf("\n\r     embMsgRequest->Type:%d ",embMsgRequest->Type());
#include stack_commands_vnv.c // rBuffEmbMsg
